...
public:
	...
	int CreateMaterial(const std::string& materialName, const Material& material) override;
	std::string CreateMorph(const Mesh& mesh, const int materialIndex) override;
