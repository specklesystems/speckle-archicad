...
// Everything runs synchronously on the ACAPI main thread: the shared Arrow
// bundle writer and WinHTTP are synchronous APIs, so the C# worker-thread
// requirement (sync-over-async parquet IO) does not apply here.
