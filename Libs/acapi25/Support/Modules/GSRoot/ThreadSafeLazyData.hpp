...
const Type& ThreadSafeLazyData<Type>::GetCalculatedOrDefaultOnFailure (const Calculator& calculate) const noexcept
{
	...
	static_assert (HasFunctionCallOperator<Calculator, void, Type&>, "Calculator must be callable with signature <void (Type&)>!");
...
const Type& ThreadSafeLazyData<Type>::GetCalculated (const Calculator& calculate) const noexcept
{
	...
	static_assert (HasFunctionCallOperator<Calculator, Type>, "Calculator must be callable with signature <Type (void)>!");
	static_assert (noexcept (calculate ()), "Calculator must be noexcept!");
