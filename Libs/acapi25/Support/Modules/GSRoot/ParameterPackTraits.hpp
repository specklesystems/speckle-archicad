...
constexpr bool			Conjunction<B, Bs...> = B && Conjunction<Bs...>;

template <>
static constexpr bool	Conjunction<> = true;			// full specialization must be static (likely clang 12.0.0 ARM64 bug)


// === Disjunction =====================================================================================================

template <bool... Bs>
constexpr bool			Disjunction = {};

template <bool B, bool... Bs>
constexpr bool			Disjunction<B, Bs...> = B || Disjunction<Bs...>;

template <>
static constexpr bool	Disjunction<> = false;			// full specialization must be static (likely clang 12.0.0 ARM64 bug)
...
struct ParameterPack<T, Ts...> {
	...
	template <class Type>
	static constexpr bool	Contains    = IsSame<Type, T> || ParameterPack<Ts...>::template Contains<Type>;
