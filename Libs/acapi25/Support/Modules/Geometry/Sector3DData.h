...
public:
	...
	Sector3D						Transform (Geometry::OrthogonalTransformation3D& transformation) const;
	GS::Optional<Sector3D>			Transform (Geometry::Transformation3D& transformation) const;
};
