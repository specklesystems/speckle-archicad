...
{
public:
	static Line2D CreateFromPoints (const Point2D& linePoint1, const Point2D& linePoint2, const DistanceTolerance& tol = DistanceTolerance { SmallEps })	CAN_THROW (UnitVector_2D::UnitVectorCreationError);
