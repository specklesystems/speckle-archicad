...
private:
			 MessageContentIBinaryChannelWrapper (const MessageContentIBinaryChannelWrapper&); // Disabled

// Operator overloading:
private:
	const MessageContentIBinaryChannelWrapper&	operator = (const MessageContentIBinaryChannelWrapper&); // Disabled
