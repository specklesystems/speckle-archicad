...
private:
			 DeflaterMessageContentOBinaryChannel (const DeflaterMessageContentOBinaryChannel&); // Disabled
public:
	virtual ~DeflaterMessageContentOBinaryChannel ();

// Operator overloading:
private:
	const DeflaterMessageContentOBinaryChannel&		operator = (const DeflaterMessageContentOBinaryChannel&); // Disabled
