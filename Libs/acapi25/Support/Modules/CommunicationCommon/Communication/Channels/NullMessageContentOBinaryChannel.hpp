...
private:
	NullMessageContentOBinaryChannel (const NullMessageContentOBinaryChannel&); // Disabled

// Operator overloading:
private:
	const NullMessageContentOBinaryChannel&		operator = (const NullMessageContentOBinaryChannel&); // Disabled
