...
private:
			 InflaterMessageContentIBinaryChannel (const InflaterMessageContentIBinaryChannel&); // Disabled
public:
	virtual ~InflaterMessageContentIBinaryChannel ();

// Operator overloading:
private:
	const InflaterMessageContentIBinaryChannel&		operator = (const InflaterMessageContentIBinaryChannel&); // Disabled
