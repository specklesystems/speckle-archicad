...
public:
	...
	FileAlertStrings () {};
	void	FillStrings (GSResModule resModule, short resID, const GS::UniString& fileName);
};
...
static 	GS::UniString		GetNamedTitleString (GSResModule resModule, short resID, short stringID, const GS::UniString& fileName);
