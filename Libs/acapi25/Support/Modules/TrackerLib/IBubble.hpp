...
class TRACKER_DLL_EXPORT IBubble
{
...
class TRACKER_DLL_EXPORT IBubbleWebView
{
public:

	virtual ~IBubbleWebView ();
	virtual void					AddBrowser (DG::BrowserBase& browser, const DG::Rect& rect) = 0;
};

class TRACKER_DLL_EXPORT IBubbleImpl : public IBubble, public ITransparentWindowImpl
{
private:
	IBubble* impl;
...
class TRACKER_DLL_EXPORT IBubbleWebViewImpl : public IBubbleWebView, public IBubbleImpl
{
private:
	IBubbleWebView* impl;
...
public:
	...
	virtual void					AddBrowser (DG::BrowserBase& browser, const DG::Rect& rect) override;
