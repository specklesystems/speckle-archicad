...
class TRACKER_DLL_EXPORT ITrackerItem
{
friend class Tracker;

protected:
	// Functions called from derived classes to access private data and methods in Tracker
	void					NotifyParentAboutBeingDeleted (Tracker& parent) { parent.ItemDeleted (this); }
	void					SetParentShowAll (Tracker& parent) { parent.ShowAllItemsWhileEdit (); }
	Hint					GetParentHint (Tracker& parent) const { return parent.hint; }
	bool					SelectInParent (Tracker& parent) { return parent.SelectItem (this); }
