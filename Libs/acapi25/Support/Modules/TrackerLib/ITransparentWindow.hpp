...
class TRACKER_DLL_EXPORT MouseClickArg : public DG::EventArg
{
public:
	DG::Point		point;
...
class TRACKER_DLL_EXPORT TransptWindowEvents
{
public:
...
class TRACKER_DLL_EXPORT ITransparentWindow
{
...
class TRACKER_DLL_EXPORT ITransparentWindowImpl : public ITransparentWindow, public TransptWindowEvents
{
private:
