...
class TRACKER_DLL_EXPORT FloatingMenu : public TransparentWindow
{
public:
	class TRACKER_DLL_EXPORT MenuRow : public GS::Object {
	private:
		bool							highlightable;
	public:
		MenuRow ();
	...
	class TRACKER_DLL_EXPORT MenuItemRow : public MenuRow {
	private:
	...
	class TRACKER_DLL_EXPORT HorizontalSeparator : public MenuRow {
	public:
	...
	class TRACKER_DLL_EXPORT MenuItemWidths {
	public:
		UInt16 fullWidth;
		UInt16 drawOffset;
		UInt16 midOffset;
	...
	class TRACKER_DLL_EXPORT LayoutStrategy {
	public:
	...
	class TRACKER_DLL_EXPORT DefaultLayout : public LayoutStrategy
	{
	public:
		virtual void	Calculate (const MenuItemRowArray& rows, const bool smallFont, LayoutData* data) const override;
	private:
		void			InitLayoutData (const MenuItemRowArray& rows, LayoutData* data) const;
	...
	class TRACKER_DLL_EXPORT CustomLayout : public LayoutStrategy
	{
	public:
		virtual void	Calculate (const MenuItemRowArray& rows, const bool smallFont, LayoutData* data) const override;
	private:
...
public:
	...
	static void			DrawRoundedRect (NewDisplay::NativeContext& context, float posX, float posY, float right, float bottom, float cornerRadius, short offsetX, unsigned short arrowSize, ArrowStyle arrowStyle);
