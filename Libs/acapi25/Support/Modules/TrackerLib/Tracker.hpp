...
class TRACKER_DLL_EXPORT Tracker:	public	TransparentWindow,
...
public:
	...
	class TRACKER_DLL_EXPORT HintGuard {
	private:
...
private:
	...
	class TRACKER_DLL_EXPORT IdleGuard {
	private:
...
public:
	...
	void				DeactivateEditMode (bool acceptValue, bool removeTrackerFromIdealPosition);
