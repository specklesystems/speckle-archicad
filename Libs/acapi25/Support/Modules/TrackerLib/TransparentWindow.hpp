...
class TRACKER_DLL_EXPORT TransparentWindow : public ITracker::ITransparentWindow, public ITracker::TransptWindowEvents
{
...
public:
	...
	class TRACKER_DLL_EXPORT AnimationDescriptor {
	public:
		typedef GS::Pair<float, float>	ValueForProgress;

		class TRACKER_DLL_EXPORT FadeAnimation {
		public:
			virtual ~FadeAnimation ();
		};

		class TRACKER_DLL_EXPORT MoveAnimation {
		public:
	...
	bool						operator== (const void* window);
