...
{
	m_attrs.textureCoordSys.origin = origin;
	m_attrs.textureCoordSys.pointX = endOfX;
	m_attrs.textureCoordSys.pointY = endOfY;
	m_attrs.textureCoordSys.pointZ = endOfZ;
}
...
{
	return m_attrs.textureCoordSys;
}
