...
#define		FROM_POINTLOAD				57
#define		FROM_EDGELOAD				58
#define		FROM_SURFACELOAD			59
...
// --- Type definitions	------------------------------------------------------------------------------------------------
 ...
 public:
	...
	enum ComparisonMethod {
		IncludeElemGuid = 0b0001,
		IncludeLayer	= 0b0010
	};

	static constexpr ComparisonMethod FullComparison = ComparisonMethod (IncludeElemGuid | IncludeLayer);

	ENABLE_FLAG_SUPPORT_IN_CLASS (ComparisonMethod);
