...
typedef enum {			// Codes for Goodies functions
	...
	APIAny_GetIFCExportTranslatorsListID 	= 'GIET',			// par1: GS::Array<API_IFCTranslatorIdentifier>*
	APIAny_GetIFCRelationshipDataID			= 'GIRD',			// par1: API_IFCTranslatorIdentifier*	par2: API_IFCRelationshipData*
	APIAny_GetIFCDifferenceStateID			= 'GIDS',			// par1: API_Guid*						par2: API_IFCTranslatorIdentifier*	par3: API_IFCDifferenceGeneratorState*
	APIAny_GetIFCDifferenceID				= 'GIDI',			// par1: API_IFCDifferenceGeneratorState*	par2: API_IFCDifferenceGeneratorState*		par3: API_IFCDifference*
	APIAny_InvokeIFCDifferenceExportSettingsDlgID = 'IIED',		// par1: API_Guid*						par2: API_IFCTranslatorIdentifier*
