...
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_DeleteMore (const API_Attr_Head *attrHead, API_AttributeIndex* attrIndexListPtr);
...
/* -- API Analytical Model -------------------- */

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetCurrentAnalyticalModel (API_Guid* amGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetCurveElements (const API_Guid& amGuid, GS::Array<API_Guid>* curveElements);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetCurveMember (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalCurveMember* api_curveMember);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetSurfaceElements (const API_Guid& amGuid, GS::Array<API_Guid>* surfaceElements);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetSurfaceMember (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalSurfaceMember* api_surfaceMember, API_ExportIdMappingType& idMapping);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetSegmentedSurfaceMember (const API_Guid& 							amGuid,
																								 const API_Guid& 							elemGuid,
																								 GS::Array<API_AnalyticalSurfaceMember>* 	api_surfaceMember,
																								 double 									centralAngle,
																								 API_ExportIdMappingType&					idMapping);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalMemberConnections (const API_Guid& amGuid, const API_Guid& elemGuid, GS::HashSet<API_Guid>& api_connections);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalMemberPartRefCoord (const API_Guid& amGuid, const API_AnalyticalMemberPartRef& api_memberPartRef, API_AnalyticalNode& api_analyticalNode);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalMemberPartRefCurve (const API_Guid& amGuid, const API_AnalyticalMemberPartRef& api_memberPartRef, API_AnalyticalCurve* api_analyticalCurve);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetCurveMemberProfileVectorImage (const API_Guid& amGuid, const API_Guid& elemGuid, ProfileVectorImage* profileImage);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalModel (const API_AnalyticalModelVariation& api_modelVariation, API_Guid* amGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalModelVariation (const API_Guid& amGuid, API_AnalyticalModelVariation* api_modelVariation);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_UpdateAnalyticalModel (const API_Guid& amGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_CreateElementFromCurveMember (const API_AnalyticalCurveMember& api_curveMember, const ProfileVectorImage* profileImage, const GS::UniString& favoriteName, API_Guid* elemGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_CreateElementFromSurfaceMember (const API_AnalyticalSurfaceMember&	api_surfaceMember,
																									  const GS::UniString&					favoriteName,
																									  API_Guid*								elemGuid,
																									  API_ImportIdMappingType*				idMapping = nullptr);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_CreateElementFromSegmentedSurfaceMember (const GS::Array<API_AnalyticalSurfaceMember>&	api_surfaceMember,
																											   const GS::UniString&								favoriteName,
																											   API_Guid*										elemGuid,
																											   API_ImportIdMappingType*							idMapping = nullptr);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetLCSOfAnalyticalMember (const API_AnalyticalMemberPartRef& api_memberPartRef, API_CoordinateSystem& localCoordinateSystem);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalRelease (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalReleaseType* api_analyticalRelease);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_SetAnalyticalRelease (const API_Guid& elemGuid, const API_AnalyticalReleaseType& api_analyticalRelease);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalSupportGeometry (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalSupportGeometry* analyticalSupportGeometry);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLinkGeometry (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalLinkGeometry*	analyticalLinkGeometry);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalPointLoadGeometry (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalPointLoadGeometry* analyticalPointLoadGeometry);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalEdgeLoadGeometry (const API_Guid& amGuid, const API_Guid& elemGuid, API_EdgeLoadCustomData* analyticalEdgeLoadGeometry);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalSurfaceLoadGeometry (const API_Guid& amGuid, const API_Guid& elemGuid, API_SurfaceLoadCustomData* analyticalSurfaceLoadGeometry);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_ConvertAnalyticalLinkToNonShortest (const API_Guid& amGuid, const API_Guid& elemGuid, API_AnalyticalLinkType* api_analyticalLink);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetComplementaryProjectMemberType (const API_Guid& elemGuid, API_AnalyticalMemberType* analyticalMemberType);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLoadGroups (GS::Array<API_Guid>* analyticalLoadGroups);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLoadGroup (const API_Guid& analyticalLoadGroupGuid, API_AnalyticalLoadGroup* analyticalLoadGroup);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_CreateAnalyticalLoadGroup (API_AnalyticalLoadGroup& analyticalLoadGroup);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_DeleteAnalyticalLoadGroup (const API_Guid& analyticalLoadGroupGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAllAnalyticalLoadCases (GS::Array<API_Guid>* analyticalLoadCases);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLoadCases (const API_Guid& analyticalLoadGroupGuid, GS::Array<API_Guid>* analyticalLoadCases);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLoadCase (const API_Guid& analyticalLoadCaseGuid, API_AnalyticalLoadCase* analyticalLoadCase);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_CreateAnalyticalLoadCase (API_AnalyticalLoadCase& analyticalLoadCase);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_DeleteAnalyticalLoadCase (const API_Guid& analyticalLoadCaseGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLoadCombinations (GS::Array<API_Guid>* analyticalLoadCombinations);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_GetAnalyticalLoadCombination (const API_Guid& analyticalLoadCombinationGuid, API_AnalyticalLoadCombination* analyticalLoadCombination);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_CreateAnalyticalLoadCombination (API_AnalyticalLoadCombination& analyticalLoadCombination);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_AddLoadCaseToLoadCombination (const API_AnalyticalLoadFactor& loadFactor, const API_Guid& analyticalLoadCombinationGuid);

__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_AnalyticalModel_DeleteAnalyticalLoadCombination (const API_Guid& analyticalLoadCombinationGuid);
