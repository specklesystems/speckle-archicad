...
class TE_DLL_EXPORT D2DrawableDeviceContext {
	...
	ID2D1PathGeometry* clipPolygon;
	GS::Rect<float> visibleRect;

	D2D1_ANTIALIAS_MODE GetAntialiasMode ();
public:
	D2DrawableDeviceContext (ID2D1RenderTarget* renderTarget, std::unordered_map<Gfx::Color, ID2D1SolidColorBrush*>* brushes, ID2D1Layer* clipLayer, ID2D1PathGeometry* clipPolygon, GS::Rect<float> visibleRect);
