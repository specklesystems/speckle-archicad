...
RS_DLL_EXPORT bool				RSGetIndString_ParamAdapter (const char* fileName, UInt32 lineCount, GS::uchar_t*   result, GSResID resID, Int32 index, GSResModule resModule, ResStringType rsType = RST_Localised);
...
RS_DLL_EXPORT bool				RSInternalTest (void);
...
RS_DLL_EXPORT bool				RSGetIndStringFunc (const char* fileName, UInt32 lineCount, GS::uchar_t* result, GSResID resID, Int32 index, GSResModule resModule, ResStringType rsType = RST_Localised);
