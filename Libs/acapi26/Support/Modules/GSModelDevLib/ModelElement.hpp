...
class GSMODELER_DLL_EXPORT Element {
	friend class ElementRelay;		// ElementRelay::ConstructElement () uses the private member variable
...
public:
	enum Type {
		...
		RailEndElement,
		BalusterSetElement,
		AnalyticalSupportElement,
		AnalyticalLinkElement,
		Opening,
		Openingframeinfill,
		Openingpatchinfill,
		ColumnSegmentElement,
		BeamSegmentElement,
		OtherElement
	};
