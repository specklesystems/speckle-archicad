...
namespace Modeler {
	...
	public:
		...
		virtual GS::Owner<GX::Pattern::FillData>				GetFillData (GSAttributeIndex fillInd) const = 0;
		...
		virtual GS::Owner<GX::Pattern::LineData>				GetLineData (GSAttributeIndex lineInd) const = 0;

		virtual	USize											GetNumPen	() const = 0;
		virtual	GS::Owner<Modeler::PenData> 					GetPenData	(short penInd) const = 0;

		virtual	GS::Owner<Modeler::BuildingMaterialData>		GetBuildingMaterialData (GSAttributeIndex bmatInd) const = 0;
		...
		virtual	GS::Owner<Modeler::MaterialData> 				GetMaterialData	(GSAttributeIndex matInd, short texPictIndex = -1) const = 0;
		virtual GS::Owner<Modeler::TextureData>					GetTextureData (GSAttributeIndex matInd, short texPictIndex) const = 0;
