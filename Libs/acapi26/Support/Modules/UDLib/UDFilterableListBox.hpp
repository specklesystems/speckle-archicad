...
class FilterableListBox : public IFilterableListBox {
private:

	ListBoxType									listBox;
	ArrayBasedTree<FilterableListBoxItemData>	arrayBasedTree;
	GS::BiHashTable<Int32, Int32>				arrayBasedTreeToDGListBoxBiHashTable;
	std::vector<short>							filteredTabIndices;

public:
	FilterableListBox (const DG::Panel& panel, short listBoxId);
	FilterableListBox (const DG::Panel& panel, const DG::Rect& listBoxRect);
	...
	//virtual Int32	GetItemIndexFromDGItemIndex (Int32 listItem) const override;
...
extern template class UD_DLL_EXPORT FilterableListBox<DG::SingleSelListBox>;
extern template class UD_DLL_EXPORT FilterableListBox<DG::MultiSelListBox>;

#endif

using FilterableSingleSelListBox = FilterableListBox<DG::SingleSelListBox>;
using FilterableMultiSelListBox = FilterableListBox<DG::MultiSelListBox>;
