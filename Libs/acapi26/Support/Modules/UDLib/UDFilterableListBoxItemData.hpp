...
public:
	...
	class UD_DLL_EXPORT TabItemData {
	private:
		GS::UniString							text;
	...
	public:
		...
		void SetBackgroundColor (const Gfx::Color& newColor);
...
public:
	...
	bool HasBackgroundColor () const;
	const Gfx::Color& GetBackgroundColor () const;
	void SetBackgroundColor (const Gfx::Color& newBackgroundColor);
	...
	void SetStatus (const DG::ListBox::ItemStatus newStatus);
