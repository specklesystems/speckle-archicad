...
private:
	...
	GS::Array<GS::Owner<VectorImageObject>>	objects;
...
public:
	...
	virtual bool		Compare (const VectorImage& op, double eps, const VectorImageDataMask& mask) const;
	...
	void				GetUsedAttributes (GS::Array<GSAttributeIndex>& lineTypes, GS::Array<GSAttributeIndex>& fills, GS::Array<GSAttributeIndex>& buildingMaterials, GS::Array<GSAttributeIndex>& surfaces) const;

	void				ReindexUsedAttributes (const GS::HashTable<GSAttributeIndex, GSAttributeIndex>& lineTypeMapping,
											   const GS::HashTable<GSAttributeIndex, GSAttributeIndex>& fillMapping,
											   const GS::HashTable<GSAttributeIndex, GSAttributeIndex>& buildingMaterialMapping,
											   const GS::HashTable<GSAttributeIndex, GSAttributeIndex>& surfaceMapping);
