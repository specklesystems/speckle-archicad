...
{
	if (this != &rhs) {
		return (m_originalRequestUrl.IsEqual (rhs.m_originalRequestUrl, GS::UniString::CaseInsensitive) &&
				m_finalRequestUrl.IsEqual (rhs.m_finalRequestUrl, GS::UniString::CaseInsensitive));
	}
