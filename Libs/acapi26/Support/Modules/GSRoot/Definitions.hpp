...
inline Int32	TruncateTo32Bit (int size)
{
	return  (Int32) size;
}

inline UInt32	TruncateTo32Bit (unsigned int uint)
{
	return  (UInt32) uint;
}

inline Int32	TruncateTo32Bit (long size)
{
	return  (Int32) size;
}

inline UInt32	TruncateTo32Bit (unsigned long ulong)
{
	return  (UInt32) ulong;
}
...
#ifdef WINDOWS
typedef Utf16Char					NChar;
#else
typedef Utf8Char					NChar;
#endif
