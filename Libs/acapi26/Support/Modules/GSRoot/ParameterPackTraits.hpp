...
constexpr bool	Conjunction (std::initializer_list<bool> boolValues)
{
...
template <bool... Bs>
constexpr bool	Conjunction = Imp::Conjunction ({ Bs... });					// C++17: (... && Bs)
...
constexpr bool	Disjunction (std::initializer_list<bool> boolValues)
{
	for (bool b : boolValues) {
		if (b)
			return true;
...
template <bool... Bs>
constexpr bool	Disjunction = Imp::Disjunction ({ Bs... });					// C++17: (... || Bs)
