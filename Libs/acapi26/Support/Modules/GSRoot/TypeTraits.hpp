...
struct Helper {
	static void				Accept (Result (Type::*) (Args...));
...
template <class Type, class Result, class... Args>
constexpr bool	HasNonConstFunctionCallOperator = ImpNonConstFunctionCallOperator::Helper<Type, Result, Args...>::Test (nullptr);
...
template <class Type, class Result, class... Args>
struct Helper {
	static void				Accept (Result (Type::*) (Args...) const);
...
template <class Type, class Result, class... Args>
constexpr bool	HasConstFunctionCallOperator = ImpConstFunctionCallOperator::Helper<Type, Result, Args...>::Test (nullptr);
