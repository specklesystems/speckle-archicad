...
public:
	...
	~EventSenderBaseImp ();
 	...
 	void	Attach (EventReceiverType& receiver, const Function& function);

	template <class EventReceiverType, class MethodPointer, ImpEventSender::IsMethodPointer<MethodPointer> = true>
	void	Attach (EventReceiverType& receiverObject, const MethodPointer& method);
...
void	EventSenderBaseImp<Args...>::Attach (EventReceiverType& receiver, const Function& function)
{
	...
	AttachCallbackFunction (receiverObject, function);
}


template <class... Args>
template <class EventReceiverType, class MethodPointer, ImpEventSender::IsMethodPointer<MethodPointer>>
void	EventSenderBaseImp<Args...>::Attach (EventReceiverType& receiverObject, const MethodPointer& method)
{
	static_assert (IsCompatible<EventReceiverType, EventReceiver>, "object must be compatible with EventReceiver");
	static_assert (!GS::IsConst<EventReceiverType>, "Receiver must be non-const!");
...
template <class... Args>
template <class Target, class MethodPointer>
void	EventSenderBaseImp<Args...>::Attach (EventReceiver& receiver, Target& object, const MethodPointer& method)
{
	DBASSERT (&receiver != nullptr);
	DBASSERT (&method != nullptr);
