...
private:
	...
	void		ReadVersion6 (GS::IChannel& ic, const GS::InputFrame& frame)										CAN_THROW ((GS::Exception));
	void		ReadVersion7 (GS::IChannel& ic, const GS::InputFrame& frame)										CAN_THROW ((GS::Exception));
	...
	void		WriteVersion6 (GS::OChannel& oc, const GS::OutputFrame& frame) const CAN_THROW ((GS::Exception));
	void		WriteVersion7 (GS::OChannel& oc, const GS::OutputFrame& frame) const CAN_THROW ((GS::Exception));
