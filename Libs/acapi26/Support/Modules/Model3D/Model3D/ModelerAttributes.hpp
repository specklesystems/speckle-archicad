...
private:
	...
	ULong				InsertMaterialData (const Modeler::IAttributeReader& attReader, GSAttributeIndex genfrom, const Modeler::MaterialData* mater);
...
public:
	...
	class MODEL3D_DLL_EXPORT OnlyModifier : MainContainerBase::OnlyModifier {
		private:
			...
			Int32 	InsertVBAttrFill (const Modeler::IAttributeReader& attReader, GSAttributeIndex fillind);
			void	GenerateFillName (short iufil, GS::UniString& fname);
			void	ConvertToUfil (UFIL* aufil, GSAttributeIndex genfrom, const GS::UniString& name, const GX::Pattern::FillData* fillData);

			void				SetMaterial (UMAT& umat, ULong index);
			ULong				InsertPenMaterial (const Modeler::IAttributeReader& attReader, short color);
			GSAttributeIndex	InsertGeneralMaterial (const Modeler::IAttributeReader& attReader, GSAttributeIndex glima, short color);
		...
		public:
			...
			GSAttributeIndex	InsertFillDefFill (const Modeler::IAttributeReader* attReader, GSAttributeIndex genfrom, const GX::Pattern::FillData* filldef);
			...
			GSAttributeIndex	GenfromToMaterialIndex (const Modeler::IAttributeReader& attReader, GSAttributeIndex genfrom);
			GSAttributeIndex	GlimaToMaterialIndex (const Modeler::IAttributeReader& attReader, short color, GSAttributeIndex glima);
