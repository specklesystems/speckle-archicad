...
{
public:
	GeneralCoordinateSystem3D (const Point3D& origo, const Vector3D& xAxis, const Vector3D& yAxis, const Vector3D& zAxis)	CAN_THROW (CoordinateSystem3D::CreationFailed);
...
public:
	...
	static OrthonormalizedCoordinateSystem3D Create (const Point3D& origo, const Vector3D& zAxisDir, const Vector3D& xAxisCandidate, bool mirrored = false)		CAN_THROW (CoordinateSystem3D::CreationFailed);
	static OrthonormalizedCoordinateSystem3D Create (const Point3D& origo, const UnitVector_3D& xAxis, const UnitVector_3D& yAxis, const UnitVector_3D& zAxis)	CAN_THROW (CoordinateSystem3D::CreationFailed);
