...
{
public:
	static Line3D CreateFromPoints (const Point3D& c1, const Point3D& c2, const DistanceTolerance& tol = DistanceTolerance { SmallEps })	CAN_THROW (UnitVectorCreationError);
