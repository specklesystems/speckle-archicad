...
public:
	D2DrawableDeviceContext(ID2D1RenderTarget* renderTarget, std::unordered_map<Gfx::Color, ID2D1SolidColorBrush*>* brushes);
	...
	void SetVisibleRect (const GS::Rect<float>& visibleRect);
