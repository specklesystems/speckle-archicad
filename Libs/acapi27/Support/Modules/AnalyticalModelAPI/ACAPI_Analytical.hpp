...
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetCurrentAnalyticalModel	(const API_Token&	token,
																			 API_Guid&			amGuid);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_UpdateAnalyticalModel		(const API_Token&	token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalModelVariation	(const API_Token&				token,
																			 const API_Guid&				amGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalModel			(const API_Token&						token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetGenerationSettingsToNoRule (const API_Token&	token);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetVisibilitySettings		(const API_Token&			token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetVisibilitySettings		(const API_Token&				token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalRelease	(const API_Token&					token,
																	 const API_Guid&					amGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetAnalyticalRelease	(const API_Token&					token,
																	 const API_Guid&					elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetCurveElements			(const API_Token&		token,
																		 const API_Guid&		amGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetCurveMember			(const API_Token&				token,
																		 const API_Guid&				amGuid,
																		 const API_Guid&				elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetSurfaceElements			(const API_Token&		token,
																			 const API_Guid&		amGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetSurfaceMember				(const API_Token&				token,
																			 const API_Guid&				amGuid,
																			 const API_Guid&				elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetSegmentedSurfaceMember		(const API_Token&							token,
																				 const API_Guid& 							amGuid,
																				 const API_Guid&							elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_CreateElementFromCurveMember	(const API_Token&						token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_CreateElementFromSurfaceMember	(const API_Token&						token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_CreateElementFromSegmentedSurfaceMember	(const API_Token&							token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetLCSOfAnalyticalMember				(const API_Token&						token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetLCSOfAnalyticalMemberInIntersection	(const API_Token&					token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalMemberConnections	(const API_Token&			token,
																				 const API_Guid&			amGuid,
																				 const API_Guid&			elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalMemberPartRefCoord	(const API_Token&						token,
																				 const API_Guid&						amGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalMemberPartRefCurve	(const API_Token&					token,
																				 const API_Guid&					amGuid,
																				 const API_AnalyticalMemberPartRef&	api_memberPartRef,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetComplementaryProjectMemberType	(const API_Token&			token,
																					 const API_Guid&			elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetElementFromLink	(const API_Token&				token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetLinkFromElement	(const API_Token&			token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLinkGeometry		(const API_Token&				token,
																				 const API_Guid&				amGuid,
																				 const API_Guid&				elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_ConvertAnalyticalLinkToNonShortest	(const API_Token&			token,
																					 const API_Guid&			amGuid,
																					 const API_Guid&			elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetElementFromSupport	(const API_Token&					token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetSupportFromElement	(const API_Token&			token,
																		 const API_Element&			element,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalSupportGeometry	(const API_Token&					token,
																			 const API_Guid&					amGuid,
																			 const API_Guid&					elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetElementFromPointLoad	(const API_Token&					token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetPointLoadFromElement	(const API_Token&				token,
																		 const API_Element&				element,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalPointLoadGeometry	(const API_Token&					token,
																				 const API_Guid&					amGuid,
																				 const API_Guid&					elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetElementFromEdgeLoad		(const API_Token&					token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetEdgeLoadFromElement		(const API_Token&				token,
																			 const API_Element&				element,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetEdgeLoadGeometry			(const API_Token&			token,
																			 const API_Guid&			amGuid,
																			 const API_Guid&			elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetMemoFromEdgeLoadCustomData	(const API_Token&				token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetEdgeLoadCustomDataFromMemo	(const API_Token&			token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetElementFromSurfaceLoad		(const API_Token&						token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetSurfaceLoadFromElement		(const API_Token&				token,
																				 const API_Element&				element,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetSurfaceLoadGeometry			(const API_Token&			token,
																				 const API_Guid&			amGuid,
																				 const API_Guid&			elemGuid,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetMemoFromSurfaceLoadCustomData	(const API_Token&					token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_SetSurfaceLoadCustomDataFromMemo	(const API_Token&			token,
																				 const API_ElementMemo&		memo,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLoadGroups	(const API_Token&		token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLoadGroup	(const API_Token&			token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_CreateAnalyticalLoadGroup	(const API_Token&			token,
																			 API_AnalyticalLoadGroup&	analyticalLoadGroup);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_DeleteAnalyticalLoadGroup	(const API_Token&	token,
																			 const API_Guid&	analyticalLoadGroupGuid);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAllAnalyticalLoadCases	(const API_Token&		token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLoadCases	(const API_Token&		token,
																		 const API_Guid&		analyticalLoadGroupGuid,
																		 GS::Array<API_Guid>&	analyticalLoadCases);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLoadCase	(const API_Token&			token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_CreateAnalyticalLoadCase	(const API_Token&			token,
																		 API_AnalyticalLoadCase&	analyticalLoadCase);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_DeleteAnalyticalLoadCase	(const API_Token&	token,
																		 const API_Guid&	analyticalLoadCaseGuid);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLoadCombinations	(const API_Token&		token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_GetAnalyticalLoadCombination	(const API_Token&				token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_CreateAnalyticalLoadCombination	(const API_Token&					token,
																				 API_AnalyticalLoadCombination&		analyticalLoadCombination);
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_AddLoadCaseToLoadCombination	(const API_Token&					token,
...
*/
ANALYTICALMODELAPI_EXPORT
GSErrCode	__ACENV_CALL ACAPI_Analytical_DeleteAnalyticalLoadCombination	(const API_Token&	token,
																				 const API_Guid&	analyticalLoadCombinationGuid);
