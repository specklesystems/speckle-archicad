...
GSROOT_DLL_EXPORT bool			DBBreak (const char *fileName, UInt32 lineCount, const char* pMessage = nullptr, const char* reason = nullptr, const char* function = nullptr, const char* assertGuidString = nullptr);
#ifdef WINDOWS
