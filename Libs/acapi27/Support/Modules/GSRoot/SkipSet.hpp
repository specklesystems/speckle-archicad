...
public:
	...
	SkipSet		Select (const std::function<bool (const Type&)>& condition) const;

	template <class ResultType, class ResultComparator = DefaultComparator<ResultType>>
	SkipSet<ResultType, ResultComparator>	Transform (const std::function<ResultType (const Type&)>& transformation) const;
...
template <class Type, class Comparator>
void	SkipSet<Type, Comparator>::ConversionEnumerator::Enumerate (const std::function<void (const Type&)>& processor) const
{
...
template <class Type, class Comparator>
SkipSet<Type, Comparator>	SkipSet<Type, Comparator>::Select (const std::function<bool (const Type&)>& condition) const
{
...
SkipSet<ResultType, ResultComparator>	SkipSet<Type, Comparator>::Transform (const std::function<ResultType (const Type&)>& transformation) const
{
