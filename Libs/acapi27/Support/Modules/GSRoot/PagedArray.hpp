...
public:
   ...
   ~PagedArray ();
	...
	PagedArray	Select (const std::function<bool (const Type&)>& condition) const;

	template <class ResultType>
	PagedArray<ResultType, PageSize>	Transform (const std::function<ResultType (const Type&)>& transformation) const;
...
template <class Type, UInt32 PageSize>
UIndex		PagedArray<Type, PageSize>::DeleteFirst (const std::function<bool (const Type&)>& condition)
{
...
template <class Type, UInt32 PageSize>
UIndex		PagedArray<Type, PageSize>::DeleteLast (const std::function<bool (const Type&)>& condition)
{
	NULL_REF_CHECK (condition);
...
template <class Type, UInt32 PageSize>
void	PagedArray<Type, PageSize>::DeleteAll (const std::function<bool (const Type&)>& condition)
{
	NULL_REF_CHECK (condition);
...
template <class Type, UInt32 PageSize>
bool	PagedArray<Type, PageSize>::ContainsOnly (const std::function<bool (const Type&)>& condition) const
{
...
template <class Type, UInt32 PageSize>
PagedArray<Type, PageSize>	PagedArray<Type, PageSize>::Select (const std::function<bool (const Type&)>& condition) const
{
...
template <class Type, UInt32 PageSize>
template <class ResultType>
PagedArray<ResultType, PageSize>	PagedArray<Type, PageSize>::Transform (const std::function<ResultType (const Type&)>& transformation) const
{
...
template <class Type, UInt32 PageSize>
GSErrCode	Print (OChannel& oc, const PagedArray<Type, PageSize>& pagedArray)
{
	pagedArray.Print (oc);
