...
private:
	...
	public:
		...
		void GetString (Owner<char[]>* str) const;
	...
	static void CopyUStr (const uchar_t* source, Owner<char[]>* str);
...
GSROOT_DLL_EXPORT const ClassInfo*	GetPropertyListTemplateClassInfo ();
