...
class BiHashTableBase : public AssociativeContainer<LeftKey, RightKey> {
public:
	BiHashTableBase ()
	{
...
public:
   ...
   ~BiHashTable ();
	...
	template <bool = EnableLeft ()> const LeftKey&	operator[] (const RightKey& rightKey) const;

	template <bool = EnableLeft ()> const LeftKey&	Get (const RightKey& rightKey) const;
	...
	template <bool = EnableLeft ()> const LeftKey*	GetPtr (const RightKey& rightKey) const;

		// Specified LeftKey access

	const LeftKey&	GetLeft (const RightKey& rightKey) const;
	...
	const LeftKey*	GetLeftPtr (const RightKey& rightKey) const;

		// RightKey access

	template <int = EnableRight ()> const RightKey&	operator[] (const LeftKey& leftKey) const;

	template <int = EnableRight ()> const RightKey&	Get (const LeftKey& leftKey) const;
	...
	template <int = EnableRight ()> const RightKey*	GetPtr (const LeftKey& leftKey) const;

		// Specified RightKey access

	const RightKey&	GetRight (const LeftKey& leftKey) const;
	...
	const RightKey*	GetRightPtr (const LeftKey& leftKey) const;
