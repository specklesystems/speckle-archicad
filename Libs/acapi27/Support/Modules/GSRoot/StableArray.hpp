...
public:
   ...
   ~StableArray ();
	...
	StableArray				Select (const std::function<bool (const Type&)>& condition) const;

	template <class ResultType>
	StableArray<ResultType>	Transform (const std::function<ResultType (const Type&)>& transformation) const;
...
template <class Type>
UIndex	StableArray<Type>::DeleteFirst (const std::function<bool (const Type&)>& condition)
{
...
template <class Type>
UIndex	StableArray<Type>::DeleteLast (const std::function<bool (const Type&)>& condition)
{
	NULL_REF_CHECK (condition);
...
template <class Type>
void	StableArray<Type>::DeleteAll (const std::function<bool (const Type&)>& condition)
{
	NULL_REF_CHECK (condition);
...
template <class Type>
bool	StableArray<Type>::ContainsOnly (const std::function<bool (const Type&)>& condition) const
{
...
template <class Type>
StableArray<Type>   StableArray<Type>::Select (const std::function<bool (const Type&)>& condition) const
{
...
template <class Type>
template <class ResultType>
StableArray<ResultType>	StableArray<Type>::Transform (const std::function<ResultType (const Type&)>& transformation) const
{
