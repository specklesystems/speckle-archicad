...
/** @brief Retrieves the number of Publisher Sets.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorSetNum-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorSetNum (Int32* setNum);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorSet (API_NavigatorSet* navigatorSet, Int32* index = nullptr);
...
/** @brief Retrieves a navigator item.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorItem-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorItem (const API_Guid* guid, API_NavigatorItem* navigatorItem);
...
/** @brief Retrieves the parent item of a navigator item.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorParentItem-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorParentItem (const API_Guid* guid, API_NavigatorItem* parent);
...
/** @brief Retrieves the number of children of a navigator item.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorChildNum-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorChildNum (API_NavigatorItem* parent, Int32* num);
...
/** @brief Retrieves the child items of a navigator item.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorChildrenItems-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorChildrenItems (API_NavigatorItem* item, GS::Array<API_NavigatorItem>* items);
...
/** @brief Retrives a navigator view.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorView-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorView (API_NavigatorItem* navigatorItem, API_NavigatorView* navigatorView);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_SearchNavigatorItem (API_NavigatorItem* item, GS::Array<API_NavigatorItem>* items);
...
/** @brief Sets the given Project Navigator item and its view settings.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_ChangeNavigatorView-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeNavigatorView (API_NavigatorItem* navigatorItem, API_NavigatorView* navigatorView);
...
/** @brief Creates a new Navigator View.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_NewNavigatorView-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_NewNavigatorView (API_NavigatorItem* navigatorItem, API_NavigatorView* navigatorView, const GS::Guid* parent = nullptr, const GS::Guid* previousSibling = nullptr);
...
/** @brief Deletes the given navigator view.
	...
	@remarks This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_DeleteNavigatorView-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_DeleteNavigatorView (const API_Guid* viewGuid, const bool* silentMode);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeNavigatorItem (API_NavigatorItem* navigatorItem);
...
/** @brief With this function a navigator item can be moved to an other place. It can be used with items on the layout map and on the view maps (in case of teamworking on the public and on the users' own view map as well.
	...
	@remarks This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_SetNavigatorItemPosition (const GS::Guid* source, const GS::Guid* parent, const GS::Guid* child);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_CloneProjectMapItemToViewMap (const API_Guid* sourceItemId, const API_Guid* parentItemId, API_Guid* createdItemId);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_CreateNavigatorVPItem (API_NavigatorAddOnViewPointData* viewPointData);
...
/** @brief Deletes a Navigator viewpoint root, group or leaf node from the Project Map.
	...
	@remarks If a root or group is deleted, all descendants are also deleted.
		Note: In teamwork mode you cannot create, change or delete viewpoint roots or groups.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_DeleteNavigatorVPItem (const API_Guid* guid);
...
/** @brief Changes an existing Navigator viewpoint root, group or leaf node in the Project Map.
	...
	@remarks viewPointData.parentGuid is ignored, i.e. the hierarchy cannot be changed with this function.
		...
		Note: In teamwork mode you cannot create, change or delete viewpoint roots or groups.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeNavigatorVPItem (API_NavigatorAddOnViewPointData* viewPointData);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorVPItem (API_NavigatorAddOnViewPointData* viewPointData);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorVPRootGroups (GS::Array<API_Guid>* rootGuids);
...
childrenGuids was nullptr.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Navigator_GetNavigatorVPItemChildren-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetNavigatorVPItemChildren (const API_Guid* guid, GS::Array<API_Guid>* childrenGuids);


/** @brief Registers an object with virtual functions that is implemented by the AddOn, and on certain events called by Archicad.
	@ingroup Navigator
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_RegisterCallbackInterface (INavigatorCallbackInterface* callBackInterface);
