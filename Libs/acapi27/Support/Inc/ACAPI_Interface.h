...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_GetMenuItemFlags (const API_MenuItemRef* menuItemRef, GSFlags* itemFlags, GS::UniString* menuItemText = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_SetMenuItemFlags (const API_MenuItemRef* menuItemRef, GSFlags* itemFlags, GS::UniString* menuItemText = nullptr); // Int32?
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_GetMenuItemText (const API_MenuItemRef* menuItemRef, char* itemText, GS::UniString* itemUniText = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_SetMenuItemText (const API_MenuItemRef* menuItemRef, char* itemText, GS::UniString* itemUniText = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_AddMenuItemText (const API_MenuItemRef* menuItemRef, char* weText, GS::UniString* weUniText = nullptr);
...
/** @brief Returns the actual process control from Archicad.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_GetProcessControl (GS::ProcessControl** processControl);
...
/** @brief Sets the given process control to Archicad.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_SetInnerProcessControl (GS::ProcessControl* processControl = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_InitProcessWindow (const GS::UniString* title = nullptr, Int32* nPhase = nullptr, API_ProcessControlTypeID* processCntrolType = nullptr);
...
/** @brief Closes the process window.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_ProcessWindow_CloseProcessWindow-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_CloseProcessWindow ();
...
/** @brief Starts the next process phase in the process window.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_ProcessWindow_SetNextProcessPhase-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_SetNextProcessPhase (const GS::UniString* subtitle, Int32* maxval, bool* showPercent = nullptr);
...
/** @brief Sets the value of the progress bar.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_ProcessWindow_SetProcessValue-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_SetProcessValue (Int32* newval);
...
/** @brief Increases the value of the progress bar.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_ProcessWindow_IncProcessValue-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_IncProcessValue (Int32* incval = nullptr);
...
/** @brief Checks for user breaks during long processes.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_ProcessWindow_IsProcessCanceled-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_IsProcessCanceled ();
...
/** @brief Initializes the neig filter for an input.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_InitNeigFilter-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_InitNeigFilter (API_NeigFilter* neigFilter, API_InitNeigFilterID initNeigFilterID);
...
/** @brief Sets one of the neig types in the neig filter to be filtered.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_SetNeigFilter-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_SetNeigFilter (API_NeigFilter* neigFilter, API_NeigID neigID);
...
/** @brief Sets one of the neig types in the neig filter not to be filtered.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_ClearNeigFilter-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_ClearNeigFilter (API_NeigFilter* neigFilter, API_NeigID neigID);
...
/** @brief Performs a point input.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_GetPoint-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_GetPoint (API_GetPointType* pointInfo, RubberLineInfoProc* rubberLineInfoProc = nullptr, Get3DComponentProc* get3DComponentProc = nullptr);
...
/** @brief Performs a line input.
	...
	@remarks This function is used to let the user input a line graphically.
		...
		Do not invoke any input operation while there are modal dialogs open.
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_GetLine-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_GetLine (API_GetLineType* lineInfo, RubberLineInfoProc* rubberLineInfoProc = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_GetArc (API_GetArcType* arcInfo, RubberLineInfoProc* rubberLineInfoProc = nullptr);
...
/** @brief Performs polygon input.
	...
	@remarks This function is used to let the user input a polygon graphically.
		...
		Do not invoke any input operation while there are modal dialogs open.
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_GetPoly-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_GetPoly (API_GetPolyType* polyInfo, API_RubberPolyCallbacks* rubberPolyCallbacks = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_DrawRubberLine (API_RubberLineType* rubberLine);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_DrawRubberArc (API_RubberArcType* rubberArc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_PetPalette (API_PetPaletteType* petPaletteInfo, APIPetPaletteCallBackProc* petPaletteProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_CompleteUserInput ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_CancelUserInput ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_SetUserControlCallback (API_UCCallbackType* callbackType);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_ObjectSettings (API_ObjectSettingsPars* objectSettingsPars);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_SettingsDialog (API_ToolBoxItem* toolBoxItem, const API_Guid* guid = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_SetConstraint (API_ConstraintPars* constraintPars);
...
/** @brief Dissolve the drawing constraint.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_UserInput_ResetConstraint-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_ResetConstraint ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_SaveLibPartFileDialog (bool* retCode, IO::Location* location, bool* browseForFolder = nullptr, GS::UniString* dialogTitle = nullptr, GS::UniString* dialogTypeStr = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_OpenLibPartFileDialog (bool* retCode, IO::Location* location, bool* isGSM, bool* wasExternalEditorInvoked);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_OpenPictureDialog (bool* retCode, IO::Location* location);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_OpenOtherObjectDialog (bool* retCode, IO::Location* location, bool* isRoom);
...
/** @brief Turns the process window on/off.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_SetProcessOnOffSwitch (bool* switchOff);
...
/** @brief Returns whether the process window will appear.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProcessWindow_GetProcessOnOffSwitch (bool* param);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetLastValidEmbeddedLPName (GS::UniString* name, IO::Location* location);


/** @brief Returns whether the 3DCutaway is enabled.
	@ingroup CuttingPlane
	@param param [out] returns the current state.
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CuttingPlane_Is3DCutawayEnabled (bool* param);


/** @brief Turns the 3DCutaway on/off.
	@ingroup CuttingPlane
	@param param [in] sets the current state.
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CuttingPlane_Set3DCutawayStatus (bool* param);


/** @brief Returns whether the Cutting Planes are visible.
	@ingroup CuttingPlane
	@param param [out] returns the current state.
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CuttingPlane_IsCuttingPlanesVisible (bool* param);


/** @brief Shows or hides the Cutting Planes.
	@ingroup CuttingPlane
	@param param [in] sets the current state.
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CuttingPlane_SetCuttingPlanesVisibility (bool* param);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ShowSelectionIn3D ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ShowAllIn3D ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_EditHierarchicalElem (const API_Guid* guid);
...
/** @brief Cancel changes in Hierarchical Elem (Curtain Wall, Stair, Railing, Beam, Column) editing mode.
	...
	@remarks ou are able to cancel changes made in Curtain Walls, Stairs, Railings, Beams and Columns 3D editing mode via this function.
		This function performs complete operations, so it cannot be called neither during undoable operations nor during non-undoable commands. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_CancelHierarchicalElem ();
...
/** @brief Accept changes in Hierarchical Elem (Curtain Wall, Stair, Railing, Beam, Column) editing mode.
	...
	@remarks You are able to accept changes made in Curtain Walls, Stairs, Railings, Beams or Columns 3D editing mode via this function.
		This function performs complete operations, so it cannot be called neither during undoable operations nor during non-undoable commands. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_OkHierarchicalElem ();
...
*/
__APIEXPORT void		__ACENV_CALL	ACAPI_UserInput_SetElementHighlight (const GS::HashTable<API_Guid, API_RGBAColor>& highlightedElems, const GS::Optional<bool>& wireframe3D = GS::NoValue, const GS::Optional<API_RGBAColor>& nonHighlightedElemsColor = GS::NoValue);
...
*/
__APIEXPORT void		__ACENV_CALL	ACAPI_UserInput_ClearElementHighlight ();
...
/** @brief Invoke generic SSA Forward dialog that warn that the user don't have SSA license.
	...
	@since Archicad 26
*/
__APIEXPORT void		__ACENV_CALL	ACAPI_Licensing_InvokeForwardDialog	();
