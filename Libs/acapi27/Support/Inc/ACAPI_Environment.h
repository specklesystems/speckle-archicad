...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIdentification_Application	(API_ServerApplicationInfo* serverApplicationInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Teamwork_ProjectSharing	(API_SharingInfo* sharingInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_GetProjectNotes	(API_ProjectNoteInfo* projectNoteInfo);
...
/** @brief Changes the data of the 'Project Info' dialog.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_ProjectSetting_ChangeProjectNotes-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_ChangeProjectNotes	(API_ProjectNoteInfo* projectNoteInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_GetLibraries	(GS::Array<API_LibraryInfo>* activeLibs, Int32* embeddedLibraryIndex = nullptr);
...
/** @brief Changes the list of loaded libraries.
	...
	@remarks This function is used to reset the list of active libraries of Archicad. The passed library folders will be enumerated. Refer to the @ref API_LibraryInfo for further details.
		...
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
	@par Example
		@snippet API_Examples.cpp ACAPI_LibraryManagement_SetLibraries-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_SetLibraries	(const GS::Array<API_LibraryInfo>* activeLibs);
...
/** @brief Resets the loaded libraries.
	...
	@remarks All the currently selected libraries will go away. You can use this command to prepare for defining your own set of libraries.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_ResetLibraries	();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_NewLibDial	(char* defName, IO::Location* newLib);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_AddLibraries	(IO::Location* newLib);
...
/** @brief Checks the currently loaded libraries.
	...
	@remarks Check the active library folders for the required Library Parts. If any of them are missing, an alert is highlighted to inform the user.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_CheckLibraries	();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_OverwriteLibPart	(bool overwriteOn);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetLibPartRefGuid	(const IO::Location* location, API_Guid* guid);
...
/** @brief This function is used to obtain the given library part's own unique ID.
   ...
   location.
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_LibraryPart_GetLibPartUnIDStr (const IO::Location *location, char *libPartUnId);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetLibPartLockStatus	(const IO::Location* location, API_LockableStatus* status, IO::Location* userCacheLibPartLocation = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_DeleteEmbeddedLibItem	(const IO::Location* location, bool keepGSMFile = false, bool silentMode = false);
...
/** @brief Delete embeded lib items.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_DeleteEmbeddedLibItems	(const GS::Array<IO::Location>* location, bool keepGSMFile = false, bool silentMode = false);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_CreateFolderInLibrary	(const IO::Location* newFolderLocationInLibrary);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_CopyFilesIntoLibrary	(const IO::Location* targetFolderLocationInLibrary, const GS::Array<IO::Location>* filesToCopy, const bool* overwriteIfExists);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Toolbox_GetToolBoxMode	(API_ToolBoxItem* toolBoxItem);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Toolbox_SetToolBoxMode	(API_ToolBoxItem* toolBoxItem);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Toolbox_GetToolBoxInfo	(API_ToolBoxInfo* toolBoxInfo, bool enableHidden = false);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_IsAutoGroupOn	(bool* autoGrp);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_IsSuspendGroupOn	(bool* suspGrp);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetViewOptions	(API_ViewOptions* viewOptions, short* attrIndex = nullptr);
...
/** @brief Changes the actual model view options.
	...
	@remarks This function is used to change the on-screen and model view options. The first part of the passed structure corresponds to the parameters in the 'Model View Options' dialog; the other fields to the elements of the View/On-Screen View Options submenu. For more information see the @ref API_ViewOptions structure.
		...
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeViewOptions	(API_ViewOptions* viewOptions, short* modelViewOptionAttributeIndex = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_GetStorySettings	(API_StoryInfo* storyInfo, UInt32 mask = 0);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_ChangeStorySettings	(API_StoryCmdType* storyCmd);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_CreateGhostRecord	(const API_GhostRecord* ghostRecord);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_GetGhostRecord	(const API_DatabaseUnId* databaseUnId, API_GhostRecord* ghostRecord);
...
/** @brief Deletes a Virtual Trace (ghost) record.
	...
	@remarks Deletes the trace record associated with the parent database.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_DeleteGhostRecord	(const API_GhostRecord* ghostRecord);
...
/** @brief Change the settings of a Virtual Trace (ghost) record.
	...
	@remarks Change the settings of the trace record associated with the parent database.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ChangeGhostRecord	(const API_GhostRecord* ghostRecord);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_GetGhostStorySettings	(API_GhostStoryType* ghostStoryType);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_GetPreferences	(void* prefs, API_PrefsTypeID prefsTypeID);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_SetPreferences	(void* prefs, API_PrefsTypeID prefsTypeID);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Conversion_GetConvertedUnitValue	(API_UnitConversionData* api_unitConvData);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_GetSunSets	(API_SunInfo* sunInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_GetPlaceSets	(API_PlaceInfo* placeInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_CanChangePlaceSets	(bool* withDialog);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_ChangePlaceSets	(API_PlaceInfo* placeInfo);
...
/** @brief Returns the Location settings of the project.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GeoLocation_GetGeoLocation-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_GetGeoLocation	(API_GeoLocation* apiGeoLocation);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_SetGeoLocation	(API_GeoLocation* apiGeoLocation);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_SurveyPoint_GetSurveyPointTransformation	(API_Tranmat* apiSPTransformation);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_SurveyPoint_IsSurveyPointVisible	(bool* spVisibility);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_SurveyPoint_SetSurveyPointVisibility	(bool* spVisibility);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_SurveyPoint_IsSurveyPointLocked	(bool* isSurveyPointLocked);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_SurveyPoint_SetSurveyPointLocked	(bool* lockedState);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_GetGDLDate	(Int32* date);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_ChangeGDLDate	(Int32* date);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserInput_GetMagicWandSets	(API_MagicWandInfo* magicWandInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_GetExportTolerance	(double* arcDiff);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Get3DProjectionSets	(API_3DProjectionInfo* proj3DInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Change3DProjectionSets	(API_3DProjectionInfo* proj3DInfo, bool* switchOnlyAxonoOrPersp = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Rendering_GetRenderingSets	(void* rendInfo, API_RendSetTypeID rendSetType, const GS::UniString* sceneName = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Rendering_ChangeRenderingSets	(void* rendEffects, API_RendSetTypeID rendSetType);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Rendering_GetRenderingSceneNames	(GS::Array<GS::UniString>* sceneNames);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Rendering_SetCurrentRenderingScene	(const GS::UniString* newCurrentSceneName);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Get3DImageSets	(API_3DFilterAndCutSettings* filterAndCutSettings);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Change3DImageSets	(API_3DFilterAndCutSettings* filterAndCutSettings, bool* mustConvert = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Get3DWindowSets	(API_3DWindowInfo* windowInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Change3DWindowSets	(API_3DWindowInfo* windowInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Get3DStyle	(API_3DStyle* style);
...
/** @brief Modifies the parameters of an existing 3D style
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_View_Get3DStyleList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Change3DStyle	(API_3DStyle* style);
...
/** @brief Creates a new 3D style.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_View_Get3DStyleList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Create3DStyle	(API_3DStyle* style);
...
/** @brief Retrieves the names of all styles in the project and/or the name of the current style.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_View_Get3DStyleList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Get3DStyleList	(GS::Array<GS::UniString>* styles, GS::UniString* current = nullptr);
...
/** @brief Sets an existing style as active.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_View_Get3DStyleList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_SetCurrent3DStyle	(const GS::UniString* name);
...
/** @brief Retrieves the 3D cutting plane settings.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_View_Get3DCuttingPlanes-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Get3DCuttingPlanes	(API_3DCutPlanesInfo* cutInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_Change3DCuttingPlanes	(API_3DCutPlanesInfo* cutInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_GetShowHideState	(bool* isShown);
...
/** @brief Changes the visibility of application.
	...
	@remarks This function is used to change visibility of application.
		...
		Supported on Windows only.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ChangeShowHideState	(bool* toShow);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectOperation_GetMiscAppInfo	(API_MiscAppInfo* miscAppInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectOperation_GetMiscPrinterInfo	(API_MiscPrinterInfo* miscPrinterInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectOperation_GetMiscPlotterInfo	(API_MiscPlotterInfo* miscPlotterInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectOperation_GetPrinterPars	(API_PrintPars* printPars);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSettings_GetSpecFolder	(API_SpecFolderID* specFolderID, IO::Location* location);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_CreateLayout	(API_LayoutInfo* layoutInfo, API_DatabaseUnId* databaseUnId, API_Guid* parent = nullptr);
...
/** @brief Returns the settings of a layout.
	...
	@remarks This function is used to retrieve the current or the given layout's parameters such as name, size and margin values.
		The properties of the layout can be changed with the @ref ACAPI_Navigator_ChangeLayoutSets environment function.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetLayoutSets	(API_LayoutInfo* layoutInfo, API_DatabaseUnId* databaseUnId = nullptr, const ULong* actualPageIndex = nullptr);
...
/** @brief Changes the settings of the current layout in Archicad.
	...
	@remarks This function is used to modify the current (master) layout parameters such as size and margin values. The size and margins are always applied to the master layout.
		...
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeLayoutSets	(const API_LayoutInfo* layoutInfo, API_DatabaseUnId* databaseUnId);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetCurrLayerComb	(API_AttributeIndex* layerCombIndex);
...
/** @brief Activates a layer combination.
	...
	@remarks This function puts the given layer combination into effect. The currently active layer combination can be retrieved with the @ref ACAPI_Navigator_GetCurrLayerComb environment function.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeCurrLayerComb	(API_AttributeIndex* layerCombIndex);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_GetCurrPenSet	(API_AttributeIndex* penSetIndex);
...
/** @brief Retrieves the lines of the grid-based drawing numbering system.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Drawing_GetNumberingGridLines-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Drawing_GetNumberingGridLines	(APINumberingGridLineProc* gridLineProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_IsAutoIntersectOn	(bool* isOn);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ChangeAutoIntersect	(bool* isOn);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Drawing_IsMarkerDrawingEnabled	(bool* enabled);
...
/** @brief Sets whether attached objects (window/door markers, drawing titles, etc.) should be processed and returned during primitive decomposition.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Drawing_ChangeMarkerDrawingEnabled-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Drawing_ChangeMarkerDrawingEnabled	(bool enabled);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_CreateCopyOfGdlUserGlobalsHandle	(GDL::Parameters** userGlobals);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_DestroyCopyOfGdlUserGlobalsHandle	(GDL::Parameters** userGlobals);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_GetDocumentFrom3DDefaults	(API_DocumentFrom3DDefaults* documentFrom3DDefaults);
...
/** @brief Changes the 3D document setting default values.
	...
	@remarks You can use this function to change the 3D document setting default values.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ChangeDocumentFrom3DDefaults	(API_DocumentFrom3DDefaults* documentFrom3DDefaults);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_GetDocumentFrom3DSettings	(API_DatabaseUnId* databaseUnId, API_DocumentFrom3DType* documentFrom3DType);
...
/** @brief Changes the 3D document settings of the specified database.
	...
	@remarks You can use this function to change the 3D document settings of the specified database.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_View_ChangeDocumentFrom3DSettings	(API_DatabaseUnId* databaseUnId, API_DocumentFrom3DType* documentFrom3DType);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_GetStructureDisplay	(API_UIStructureDisplay* uiStructureDisplay);
...
/** @brief Changes the partial structure display options for the current database.
	...
	@remarks You can use this function to change the partial structure display settings.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ChangeStructureDisplay	(API_UIStructureDisplay* uiStructureDisplay);


/** @brief Returns if applicaton is in curtain wall editing mode.
	@ingroup HierarchicalEditing
	@param isInEditMode [out] Is the application in curtain wall editing mode?
	@param editedCurtainWall [out] (optional) The GUID of the currently edited curtain wall.
	@return
		- NoError - The function completed with success.
		- APIERR_BADPARS - isInEditMode is nullptr
	@remarks You can use this function to check the state of the applicaton; many things work differently in curtain wall editing mode.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_IsInCurtainWallEditMode	(bool* isInEditMode, API_Guid* editedCurtainWall = nullptr);


/** @brief Returns if the current user has the specifed access right.
	@ingroup Teamwork
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Teamwork_GetTWAccessRight	(API_TWAccessRights accessRight, bool* hasRight);


/** @brief Tells if Archicad is in Stair Editing mode.
	@ingroup HierarchicalEditing
	@param isInEditMode [out] true if Archicad is in Stair Edit mode, false otherwise.
	@param editedStair The GUID of the stair being edited.
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_IsInStairEditMode	(bool* isInEditMode, API_Guid* editedStair = nullptr);


/** @brief Returns if applicaton is in beam editing mode.
	@ingroup HierarchicalEditing
	@param isInEditMode [out] Is the application in beam editing mode?
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_IsInBeamEditMode	(bool* isInEditMode, API_Guid* editedBeam = nullptr);


/** @brief Returns if applicaton is in column editing mode.
	@ingroup HierarchicalEditing
	@param isInEditMode [out] Is the application in column editing mode?
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_IsInColumnEditMode	(bool* isInEditMode, API_Guid* editedColumn);
...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_Grouping_ChangeSuspendGroup (bool suspendGroups);
...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_LibraryManagement_GetLibPartOrigLocation (const Int32*  libItemIndex,
