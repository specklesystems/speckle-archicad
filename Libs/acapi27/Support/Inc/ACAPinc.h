...
*/	// CheckEnvironment
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_RegisterSupportedService (GSType cmdID, Int32 cmdVersion);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterRequiredService (const API_ModulID	*modulID,
																						GSType				cmdID,
																						Int32				cmdVersion);
...
*/	// RegisterInterface
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_RegisterMenu	(short			menuStrResID,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterFileType (Int32			refCon,
																				 GSType			ftype,
																				 GSType			fcreator,
																				 const char		*extname,
																				 short			iconResID,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_RegisterSubtype	(GSType				signature,				// identifier
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterSettingsPanel	(Int32					refCon,
...
/** @brief Appends a custom panel to an attribute settings dialog.
	...
	@remarks This function appends a new panel into an attribute settings dialog.
		For more details refer to the general description of Custom Panels in Settings Dialogs.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterAttributePanel	(Int32					refCon,
																						 API_AttrTypeID			attr,
																						 short					iconId,
																						 short					stringId,
																						 short					pageId,
...
/** @brief Appends a custom panel to the info box.
	...
	@remarks This function appends a new panel into an element settings dialog specified by tool. In order to get panel create/destroy events you must install the panel handler callback functions with @ref ACAPI_AddOnIntegration_InstallPanelHandler.
		...
		For more details refer to the general description of Custom Panels in Settings Dialogs.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterInfoBoxPanel	(Int32					refCon,
																					 const API_ElemType&	tool,
																					 short					stringId,
																					 short					pageId,
																					 bool					visibleByDefault = false);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_RegisterESYM	(GSType			signature,				// LibPart owner ID
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_RegisterPropertyObjectHandler (short assignStrResID);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterBuiltInLibrary (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterModulDataHandler (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterClassificationVisibilityHandler (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_RegisterPropertyVisibilityHandler (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnObject_RegisterAddOnObjectHandler (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterNavigatorAddOnViewPointDataHandler (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterSettingsObserver (const API_ElemType& tool);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterAttributeImportFormat (const API_AttributeManagerFormat& formatData);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_RegisterPublishFormat (const API_PublishFormatData& formatData);
...
*/	// Initialize
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallModulCommandHandler  (GSType					cmdID,
																							Int32					cmdVersion,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_MenuItem_InstallMenuHandler  (short					menuStrResID,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallFileTypeHandler  (GSType					cmdID,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallFileTypeHandler3D	   (GSType					cmdID,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallPanelHandler (Int32					refCon,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_InstallAddOnCommandHandler (GS::Owner<API_AddOnCommand> addOnCommand);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_InstallESYMHandler (GSType					signature,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_InstallPropertyObjectHandler	(short					 		strResID,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallModulDataMergeHandler	(APIModulDataMergeHandlerProc* mergeHandlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallModulDataSaveOldFormatHandler (APIModulDataSaveOldFormatHandlerProc* modulDataSaveOldFormatProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallElemSetSaveOldFormatHandler (APIElemSetSaveOldFormatHandlerProc* elemSetSaveOldFormatProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnObject_InstallAddOnObjectMergeHandler			(APIAddonObjectMergeHandlerProc*				mergeHandlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnObject_InstallAddOnObjectSaveOldFormatHandler	(APIAddonObjectSaveOldFormatHandlerProc*		saveOldFormatProc);
...
/** @brief Installs a callback procedure for converting old format AddOnObject data into current format.
	...
	@remarks In order to convert the add-on's AddOnObject data into current format, you need to implement this callback function, and pass it to Archicad with @ref ACAPI_AddOnObject_InstallAddOnObjectConvertNewFormatHandler during the Initialize phase. It is also necessary to notify Archicad about this capability of the add-on by calling @ref ACAPI_AddOnObject_RegisterAddOnObjectHandler from the RegisterInterface function.
		...
		You must pay attention to not create more than one @ref API_AddonObject s with the same name if the AddOnObject is Unique.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnObject_InstallAddOnObjectConvertNewFormatHandler (APIAddonObjectConvertNewFormatHandlerProc*	convertNewFormatProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallNavigatorAddOnViewPointDataMergeHandler			 (APINavigatorAddOnViewPointDataMergeHandlerProc*				mergeHandlerProc);
...
/** @brief Installs a callback procedure for converting Navigator AddOn viewpoints into older format.
	...
	@remarks This function should be called in the Initialize function of your AddOn.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallNavigatorAddOnViewPointDataSaveOldFormatHandler	 (APINavigatorAddOnViewPointDataSaveOldFormatHandlerProc*		saveOldFormatProc);
...
/** @brief Installs a callback procedure for converting Navigator AddOn viewpoints into current format.
	...
	@remarks This function should be called in the Initialize function of your AddOn.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallNavigatorAddOnViewPointDataConvertNewFormatHandler (APINavigatorAddOnViewPointDataConvertNewFormatHandlerProc*	convertNewFormatProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallSettingsHandler (const API_ElemType&			tool,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallClassificationVisibilityHandler (APIClassificationVisibilityHandlerProc* handlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_InstallPropertyVisibilityHandler (APIPropertyVisibilityHandlerProc* handlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallPublisherSaveMethod (const char* mimeType, SaveProc* saveProc);
...
/** @brief Installs the option methods for the Publisher
	...
	Example Refer to the Format Register Test example project of the API Development Kit.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallPublisherSaveOption (const char* mimeType, SaveOptionProc* saveOptionProc);
...
/** @brief Installs the translator getter function for the Publisher
	...
	Example Refer to the Format Register Test example project of the API Development Kit.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallPublisherTranslatorGetter (const char* mimeType, TranslatorGetterProc* translatorGetterProc);
...
/** @brief Installs the default translator getter function for the Publisher
	...
	Example Refer to the Format Register Test example project of the API Development Kit.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallPublisherDefaultTranslatorGetter (const char* mimeType, DefaultTranslatorGetterProc* defaultTranslatorGetterProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnIntegration_InstallAttrManagerImportMethod (const GS::UniString& fileExtension, ImportAttrProc* importProc);
...
/** @brief Informs Archicad about the additionally created file during exporting or publishing. Required for handling them with the target file. (E.g. uploading to BIMcloud together.)
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectOperation_AdditionalFileWasCreated (const IO::Location& path);
...
/** @brief Saves custom preferences data into the preferences file.
	...
	@remarks This function is used to save your own options or preferences into the preferences file of the server application, and can be later retrieved with @ref ACAPI_GetPreferences.
		If you store incompatible versions of preferences data in different Archicad releases, use the @ref ACAPI_Preferences_OldVersion function to define preferences to be saved into the older project file formats.
*/
...
/** @brief Returns the stored preferences of the add-on.
	...
	@remarks (1) You can retrieve the stored preferences of your add-on. This information was previously passed onto the add-on as a parameter of the DoCommand function.
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Preferences_Platform (Int32			*version,
																	   GSSize			*nByte,
																	   void				*data,
...
/** @brief Defines custom preferences data to be saved into older project file versions.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Preferences_OldVersion-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Preferences_OldVersion (Int32				version,
																		 GSSize				nByte,
																		 const void*		data,
																		 unsigned short		platformSign,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Font_GetFont		(API_FontType& font);
...
/** @brief Search for a font by name
	...
	@return
		...
		- APIERR_BADNAME - font with the given name does not exist.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Font_SearchFont	(API_FontType& font);
...
/** @brief Get the number of fonts. You could use it to iterate over the fonts
	...
	@return
		- the number of fonts
*/
__APIEXPORT Int32		__ACENV_CALL	ACAPI_Font_GetFontNum	();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_ModifyPen		(const API_Pen& pen);
...
/** @brief Returns a pen by index from the active pentable
	...
	@return
		...
		- APIERR_NOCURRATTRSET - no current attributeset
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_GetPen		(API_Pen& pen);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_GetPenNum		(UInt32& count);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideCombinationList (GS::Array<API_Guid>& combinationList);
...
/** @brief Retrieves a list of all override rule groups in the current plan.
	...
	@return
		- NoError - The function has completed with success.
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_GetOverrideRuleGroupList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideRuleGroupList	(GS::Array<API_Guid>& ruleGroupList);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideRuleList		  (GS::Array<API_Guid>& ruleList);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideCombination	(API_OverrideCombination& combination,
...
/** @brief Retrieves an override rule group identified by its guid or name.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_GetOverrideRuleGroup-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideRuleGroup	(API_OverrideRuleGroup& ruleGroup,
																						 GS::Array<API_Guid>* ruleList = nullptr);
...
/** @brief Retrieves an override rule identified by its guid.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_GetOverrideRuleById-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideRuleById			(API_OverrideRule& rule);
...
/** @brief Retrieves an override rule identified by its name.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_GetOverrideRuleByName-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetOverrideRuleByName	  (API_OverrideRule& rule, const API_Guid& ruleGroup);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_CreateOverrideCombination  (API_OverrideCombination& combination,
...
/** @brief Creates an override rule group.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_CreateOverrideRuleGroup-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_CreateOverrideRuleGroup		(API_OverrideRuleGroup& ruleGroup);
...
/** @brief Creates an override rule.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_CreateOverrideRule-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_CreateOverrideRule		  (API_OverrideRule& rule, const API_Guid& ruleGroup);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_ChangeOverrideCombination  (const API_OverrideCombination& combination,
...
/** @brief Changes an override rule group identified by its guid.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_ChangeOverrideRuleGroup-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_ChangeOverrideRuleGroup	(const API_OverrideRuleGroup& ruleGroup);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_ChangeOverrideRule		  (const API_OverrideRule& rule);
...
/** @brief Moves an override rule between override rule groups.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_MoveOverrideRule-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_MoveOverrideRule	(const API_Guid& rule, const API_Guid& targetRuleGroup, const API_Guid* nextRule);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_DeleteOverrideCombination  (const API_Guid& combination);
...
/** @brief Deletes an override rule group identified by its guid and deletes all the override rules it contains.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_DeleteOverrideRuleGroup-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_DeleteOverrideRuleGroup  (const API_Guid& ruleGroup);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_DeleteOverrideRule		  (const API_Guid& rule);
...
/** @brief Sets the order of rule groups in the current project.
	...
	@return
		...
		- APIERR_NOACCESSRIGHT - Insufficient teamwork permission or tried to move a built-in rule
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_SetOverrideRuleGroupOrder-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_SetOverrideRuleGroupOrder	(const GS::Array<API_Guid>& orderedRuleGroupIds);
...
/** @brief Sets the order of rules in the specified override rule group.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_GraphicalOverride_SetOverrideRuleOrder-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_SetOverrideRuleOrder	(const API_Guid& ruleGroup, const GS::Array<API_Guid>& orderedRuleIds);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_GetNum (API_AttrTypeID typeID, UInt32& count);
...
/** @brief Returns the instances of a given attribute type in the database.
	...
	@return
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_GetAttributesByType (API_AttrTypeID typeID, GS::Array<API_Attribute>& attributes);
...
/** @brief Iterates the instances of a given attribute type in the database.
	...
	@return
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_EnumerateAttributesByType (API_AttrTypeID typeID, const std::function<void (API_Attribute&)>& processor);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserData_GetUserData (API_Attr_Head			*attrHead,
...
/** @brief Attaches user data to an attribute, or deletes the attached data.
	...
	@remarks This function is used to attach user data to an an atribute, or to delete the attached information (if userData->dataHdl is nullptr. The caller is responsible for allocating and deleting the userData->dataHdl. You can safely destroy the passed handle after use, as it is copied into the internal database.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserData_SetUserData (API_Attr_Head					*attrHead,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_CreateAttributePicker (const API_AttributePickerParams& attributePickerParams,
...
__APIEXPORT API_AttributeIndex	__ACENV_CALL	ACAPI_Attribute_GetFirstValidAttribute (API_AttrTypeID typeID);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetNum (Int32 *count);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_Search (API_LibPart *ancestor, bool createIfMissing, bool onlyPlaceable = false);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_PatternSearch (const API_LibPart *ancestor, const GS::UniString& pattern, API_LibPart result[50], Int32* numFound);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_Get (API_LibPart *libPart);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetParams (Int32			libInd,
																 double			*a,
																 double			*b,
																 Int32			*addParNum,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetSection (Int32					libInd,
...
/** @brief Updates a section of a registered Library Part.
	...
	@remarks This function is used to update the requested section of the library part defined by libInd with the data in the supplied handle.
		...
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_UpdateSection (Int32						libInd,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_SetUpSect_2DDrawHdl (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetSect_2DDrawHdl (GSHandle *sectionHdl);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetSect_ParamDef (const API_LibPart	*libPart,
																		API_AddParType		**addPars,
																		double				*a,
																		double				*b,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_Create (const API_LibPart *libPart);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_AddSection (const API_LibPartSection	*section,
																  GSHandle					sectionHdl,
																  GS::UniString				*sectionStr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_NewSection (const API_LibPartSection *section);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_WriteSection (Int32 nByte, GSConstPtr data);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_EndSection (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_Save (API_LibPart *libPart);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_ShapePrims (Int32				libInd,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetHotspots (Int32				libInd,
																   const API_Guid&		instanceElemGuid,
																   Int32*				nHotspots,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_Register (API_LibPart *libPart);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_RegisterAll (GS::Array<API_LibPart>* libParts);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetSectionList (Int32					libInd,
																	  Int32					*nSection,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetDetails (Int32					libInd,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_SetDetails_ParamDef (const API_LibPart		*libPart,
																		   GSHandle					paramHdl,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetConnectedElements (const API_Guid&			guid,
...
/** @brief @brief Retrieves all additional information of the sub elements of an external hierarchical element.
	...
	@return
		...
		- APIERR_MEMFULL - not enough memory to complete the operation
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetMemo_ExternalHierarchical (const API_Guid&		guid,
																					UInt32				nSubElems,
																					API_SubElement*		subElems,
																					UInt64				mask = APIMemoMask_All);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_Tool (const GS::Array<API_Guid>&	elemGuids,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Selection_Select (const GS::Array<API_Neig>& selNeigs, bool add);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Selection_DeselectAll ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_UserData_DeleteUserData (API_Elem_Head *elemHead);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ElementLink_Link (const API_Guid&	guid_linkFrom,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ElementLink_Unlink (const API_Guid&	guid_linkFrom,
															  const API_Guid&	guid_linkTo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ElementLink_GetLinks (const API_Guid&			guid_linkFrom,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ElementLink_GetLinkFlags (const API_Guid&	guid_linkFrom,
																	const API_Guid&	guid_linkTo,
																	GSFlags			*linkFlags);
...
/** @brief Returns the elements observed by the add-on.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_GetObservedElements (GS::Array<API_Elem_Head> *elemHeads);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ModelAccess_Get3DInfo			(const API_Elem_Head&	elemHead,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_DrawingPrimitive_ShapePrims				(const API_Elem_Head&	elemHead,
																				 ShapePrimsProc			*shapePrimsProc);
...
/** @brief Virtually draws the shape of an element
	...
	@remarks This function draws the element from drawing primitives (see @ref API_PrimElement), using the shapePrimsProc function.
		...
		To enable Renovation Overrides or Graphical Overrides see @ref ACAPI_GraphicalOverride_EnableRenovationOverride and @ref ACAPI_GraphicalOverride_EnableVisualOverride.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_DrawingPrimitive_ShapePrimsExt (const API_Elem_Head&	elemHead,
																	 ShapePrimsProc			*shapePrimsProc,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ElementLink_GetLinkedPropertyObjects (const API_Elem_Head		*head,
																				bool					*criteria,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ElementLink_SetLinkedPropertyObjects (API_Elem_Head		*head,
																				bool				criteria,
																				Int32				inviduallyLibInd);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Category_GetCategoryValue (const API_Guid&					elemGuid,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Category_GetCategoryValueDefault (const API_ElemType&			type,
																			   const API_ElemCategory&		elemCategory,
																			   API_ElemCategoryValue*		elemCategoryValue);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Category_SetCategoryValue (const API_Guid&					elemGuid,
																		const API_ElemCategory&			elemCategory,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Category_SetCategoryValueDefault (const API_ElemType&				type,
																			   const API_ElemCategory&			elemCategory,
																			   const API_ElemCategoryValue&		elemCategoryValue);
...
/** @brief Get IFC Identifier of an element
	...
	@remarks This function returns the IFC Identifier of an element. There are two type of identifiers:
		...
		Conversion from @ref API_Guid to IFC Guid string (IfcGloballyUniqueId) can be done with @ref ACAPI_IFC_APIGuidToIFCGuid.
*/
...
/** @brief Get elements having a certain IFC identifier
	...
	@remarks This function searches for elements having the indicated IFC Guid.
		...
		Conversion from IFC Guid string (IfcGloballyUniqueId) to @ref API_Guid can be done with @ref ACAPI_IFC_IFCGuidToAPIGuid.
*/
...
/** @brief Get IFC type and IfcTypeObject IFC type of an element
	@ingroup Element
	@ingroup IFC
	@param elementID [in] GUID of the element
	@param ifcType [out] IFC type of the element
	@param typeObjectIFCType [out] IFC type of the IfcTypeObject of the element
	@return
		- NoError - The function has completed with success.
		- APIERR_BADID - Invalid value passed in the elementID parameter.
		- APIERR_MODULNOTINSTALLED - IFC add-on is not present.
...
/** @brief Get the primitive type of an IFC type.
	@ingroup Element
	@ingroup IFC
	@param valueType [in] IFC type of the property value
	@param primitiveType [out] Primitive type of the IFC type, see @ref API_IFCPropertyAnyValue for values.
	@return
		- NoError - The function has completed with success.
...
/** @brief Retrieves all of the property definitions that are available for an element.
	...
	@param filter [in] Filter the list of property definitions (API_PropertyDefinitionFilter_UserDefined, @c API_PropertyDefinitionFilter_FundamentalBuiltIn, @c API_PropertyDefinitionFilter_UserLevelBuiltIn, @c API_PropertyDefinitionFilter_All).
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL    ACAPI_Element_GetCollisions (const GS::Array<API_Guid>&					guidSet1,
...
/** @brief Makes a property definition available for all of given elements (it is created if it does not exist).
	@ingroup Property
	@param definition [in] The GUID of the definition (if already existing) or the data of the definition to create.
[out] The GUID of the definition (if newly created) and the modified availability array.
	@param elemGuids [in] The array of elements, that the property should be available for.
	@return
		- NoError - The function has completed with success.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Property_AddProperty-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_AddProperty (API_PropertyDefinition& definition, const GS::Array<API_Guid>& elemGuids);
...
*/
__APIEXPORT GSErrCode   __ACENV_CALL	ACAPI_Property_ModifyPropertyValue (const API_Property& property, const GS::Array<API_Guid>& elemGuids);


/** @brief Makes a property definition unavailable for all of given elements.
	@ingroup Property
	@param definitionGuid [in] The GUID of the definition to remove from the elements.
	@param elemGuids [in] The array of elements, that the property should not be available for.
	@return
		- NoError - The function has completed with success.
		- APIERR_NOACCESSRIGHT - Do not have the right to modify a property definition on a teamwork server.
		- APIERR_BADID - One of the elemGuids did not refer to a valid element.
	@par Example
		@snippet API_Examples.cpp ACAPI_Property_DeleteProperty-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_DeleteProperty (const API_Guid& definitionGuid, const GS::Array<API_Guid>& elemGuids);



/** @brief Makes a property definition available for all of given attributes (it is created if it does not exist).
	@ingroup Attribute
	@param definition [in/out] The GUID of the definition (if already existing) or the data of the definition to create. Once the operation is completed successfully this will hold the GUID of the definition (if newly created) and the modified availability array.
	...
	@return
		...
		- APIERR_BADVALUE - One of enumerations did not have their value out of the allowed ones. This includes c++ enums (i.e. they were uninitialized or memsetted), and enumeration property values (the possibleEnumValues doesn't contain the default value)
	@par Example
		@snippet API_Examples.cpp ACAPI_Attribute_AddProperty-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_AddProperty (API_PropertyDefinition& definition, const GS::Array<API_Attr_Head>& attrHeaders);
...
*/
__APIEXPORT GSErrCode   __ACENV_CALL	ACAPI_Attribute_ModifyPropertyValue (const API_Property& property, const GS::Array<API_Attr_Head>& attrHeaders);


/** @brief Makes a property definition unavailable for all of given attributes.
	@ingroup Attribute
	@param definitionGuid [in] The GUID of the definition to remove from the attributes.
	@param attrHeaders [in] The array of attributes, that the property should be available for.
	@return
		- NoError - The function has completed with success.
		- APIERR_NOACCESSRIGHT - Do not have the right to modify a property definition on a teamwork server.
		...
		- APIERR_READONLY - Tried to modify a read-only property (for example a property coming from a hotlink).
	@par Example
		@snippet API_Examples.cpp ACAPI_Attribute_DeleteProperty-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Attribute_DeleteProperty (const API_Guid& definitionGuid, const GS::Array<API_Attr_Head>& attrHeaders);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Teamwork_GrantElements (const GS::Array<API_Guid>& elemGuids, short toUserId);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetPropertyDefinitions	(const API_ElemComponentID&			elemComponent,
																					 API_PropertyDefinitionFilter		filter,
																					 GS::Array<API_PropertyDefinition>&	propertyDefinitions);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetPropertyValue		(const API_ElemComponentID& elemComponent,
																					 const API_Guid&			propertyDefinitionGuid,
																					 API_Property&				property);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetPropertyValues		(const API_ElemComponentID&					elemComponent,
																					 const GS::Array<API_PropertyDefinition>&	propertyDefinitions,
																					 GS::Array<API_Property>&					properties);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetPropertyValuesByGuid	(const API_ElemComponentID&	elemComponent,
																					 const GS::Array<API_Guid>&	propertyDefinitions,
																					 GS::Array<API_Property>&	properties);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_DifferenceGenerator_GetState (API_ElemDifferenceGeneratorTypeID	type,
...
/** @brief It gives back the differencies between two states.
	...
	@return
		...
		- APIERR_GENERAL - There is no current plan open.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_DifferenceGenerator_GenerateDifference (API_ElemDifferenceGeneratorTypeID		type,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_GetVisualOverriddenImage (const API_Guid&				elemGuid,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_GetNoteAutotexts (const API_ElemType& noteOwnerType,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_GetNoteKeywordForAutotextID (API_NoteAutotextID autotextID,
...
/** @brief Exports a BCF file to specified location.
	...
	@remarks Use this function to export BCF files.
		For deatails about External IFC ID and Archicad IFC ID see: @ref ACAPI_Element_GetIFCIdentifier.
	@par Example
...
*/
/* -- Drawing update */
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Drawing_Update_Drawings	(const GS::Array<API_Guid>&	drawingsToUpdate);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_CreateGroup (const GS::Array<API_Guid>&	elemGuids,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetGroup (const API_Guid&		elemGuid,
																 API_Guid*				groupGuid);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetRootGroup (const API_Guid&		elemGuid,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetGroupedElems (const API_Guid&		 groupGuid,
																		    GS::Array<API_Guid>* elemGuids);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetAllGroupedElems (const API_Guid&		groupGuid,
																		   GS::Array<API_Guid>*	elemGuids);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetUserData (const API_Guid&		groupGuid,
...
/** @brief Attaches the user data to the element group.
	...
	@remarks This function is used to attach user data to an element group. Use the @ref ACAPI_Grouping_GetUserData function to get data from the element group. Existing user data can be deleted by setting userData input parameter to nullptr.
		...
		The caller should allocate and deallocate the userData->dataHdl handle.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_SetUserData (const API_Guid&		groupGuid,
																		const API_UserData*	userData);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_ModelAccess_GetNum (API_3DTypeID typeID, Int32 *count);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_ModelAccess_GetComponent (API_Component3D *component);
...
The polygon type cannot be queried directly; no active body
	...
	@remarks This function is used to decompose a polygon into convex polygons. The polygon is defined by ipgon index.
		...
		Do not forget to dispose the returned handle if it is not needed any more.
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_ModelAccess_DecomposePgon (Int32 ipgon, Int32 ***cpoly);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Sight_CreateSight (void** newSightPtr);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Sight_SelectSight (void* sightPtr, void** oldSightPtr);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Sight_DeleteSight (void* sightPtr);
...
/** @brief Returns the current window sight.
	...
	@
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Sight_GetCurrentWindowSight (void** sightPtr);
...
The body cannot be queried directly; not active body
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_CuttingPlane_GetCutPolygonInfo-Example-Snippet
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_CuttingPlane_GetCutPolygonInfo (Int32 									bodyIndex,
...
*/
__APIEXPORT Int32		__ACENV_CALL	ACAPI_OldListing_GetSetNum (void);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_OldListing_GetSet (API_ListDataSetType *listdataSet);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_OldListing_GetNum (Int32 setIndex, API_ListDataID typeID, Int32 *count);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_OldListing_Get (API_ListData *listdata);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_OldListing_Search (API_ListData *listdata);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_OldListing_GetLocal (Int32 libIndex, const API_Elem_Head *elemHead, API_ListData *listdata);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_Test	(const API_ModulID*	mdid,
															 GSType				cmdID,
															 Int32				cmdVersion);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_Call	(const API_ModulID*	mdid,
															 GSType				cmdID,
															 Int32				cmdVersion,
															 GSHandle			params,
															 GSPtr				resultData,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_ExternalCall	(const IO::Location*		projectFileLoc,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_CallFromEventLoop	(const API_ModulID*			mdid,
																		 GSType						cmdID,
																		 Int32						cmdVersion,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectOperation_CatchProjectEvent		(GSFlags						eventTypes,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_CatchViewEvent			(GSFlags						eventTypes,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_CatchToolChange		(APIToolChangeHandlerProc		*handlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_CatchSelectionChange	(APISelectionChangeHandlerProc	*handlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_CatchChangeDefaults	(const API_ToolBoxItem			*elemType,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_CatchNewElement		(const API_ToolBoxItem			*elemType,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_CatchAttributeReplacement	(APIAttributeReplacementHandlerProc  *handlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_InstallElementObserver	(APIElementEventHandlerProc		*handlerProc);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_GetTranParams			(API_ActTranPars *actTranPars);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_GetParentElement		(API_Element*			element,
																			 API_ElementMemo*		memo,
																			 UInt64					mask,
																			 API_ElementUserData*	userData);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_CatchElementReservationChange	(APIReservationChangeHandlerProc*	handlerProc,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_CatchLockableReservationChange	(APILockChangeHandlerProc*			handlerProc,
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Licensing_CatchLicenseBorrowStatusChange	(APILicenseBorrowStatusChangeHandlerProc*	handlerProc);
...
/** @brief Sends out an @c APINotify_ClassificationVisibilityChanged project event notification to the other add-ons to state that at least one classification's visibility has changed.
	...
	@return
		- NoError - The function completed successfully.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_ClassificationVisibilityChanged ();
...
/** @brief Sends out an @c APINotify_PropertyVisibilityChanged project event notification to the other add-ons to state that at least one property's visibility has changed.
	...
	@return
		- NoError - The function completed successfully.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_PropertyVisibilityChanged ();
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_RegisterEventHandler (GS::Owner<API_IEventHandler> eventHandler, API_Guid& id);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Notification_UnregisterEventHandler (const API_Guid& id);
...
*/
__APIEXPORT bool				__ACENV_CALL	ACAPI_Teamwork_HasConnection (void);
...
*/
__APIEXPORT bool				__ACENV_CALL	ACAPI_Teamwork_IsOnline (void);
...
*/
__APIEXPORT bool				__ACENV_CALL	ACAPI_Teamwork_IsServerLibPart (const IO::Location& location);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_GetTeamworkProjectDetails (const IO::Location&	twProjectLocation,
...
*/
__APIEXPORT bool				__ACENV_CALL	ACAPI_Teamwork_HasCreateRight (const API_Guid& objectId);
...
*/
__APIEXPORT bool				__ACENV_CALL	ACAPI_Teamwork_HasDeleteModifyRight (const API_Guid& objectId);
...
*/
__APIEXPORT API_LockableStatus	__ACENV_CALL	ACAPI_Teamwork_GetLockableStatus (const API_Guid&				objectId,
...
/** @brief Retrieves the unique identifier of a lockable object set with a string identifier.
	...
	@remarks This function is used to retrieve the identifier of a named lockable object set, such as attribute types, favorites, model view options.
		...
		|Renovation Override Styles | "GraphicOverrides"|
...
*/
__APIEXPORT API_Guid			__ACENV_CALL	ACAPI_Teamwork_FindLockableObjectSet (const GS::UniString&		objectSetName);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReserveLockable (const API_Guid&					objectId,
																					   GS::PagedArray<short>*			conflicts = nullptr,
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReleaseLockable (const API_Guid&					objectId,
																					   bool								enableDialogs = true);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReserveElements (const GS::Array<API_Guid>&		elements,
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReleaseElements (const GS::Array<API_Guid>&		elements,
																					   bool								enableDialogs = true);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReserveHotlinkCacheManagement (short* conflict = nullptr);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReleaseHotlinkCacheManagement (void);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_GetHotlinkCacheManagementOwner (short* owner);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_GetUsernameFromId (short userId, GS::UniString* username);
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_SendChanges (const GS::UniString&	comment = "");
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Teamwork_ReceiveChanges ();
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Property_GetPropertyValueString		(const API_Property&	apiProperty,
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_Window_Check (API_ActionCenterItemID item);


/* -- IFC ------------------------------ */


/** @brief It converts an @ref API_Guid to an IfcGloballyUniqueId string.
	@ingroup IFC
	@since Archicad 26
	@param ifcGuid [in] IfcGloballyUniqueId string need to be converted.
	@param apiGuid [out] The resulting @ref API_Guid.
	@return
		- NoError - The function has completed with success.
		- APIERR_BADPARS - If any error occured during the conversion.
	@remarks It converts an IfcGloballyUniqueId string to @ref API_Guid.
...
/** @brief It converts an @ref API_Guid to an IfcGloballyUniqueId string.
	@ingroup IFC
	@since Archicad 26
	@param apiGuid [in] @ref API_Guid need to be converted.
	@param ifcGuid [out] The resulting IfcGloballyUniqueId string.
	@return
		- NoError - The function has completed with success.
		- APIERR_BADPARS - If any error occured during the conversion.
	@remarks It converts an @ref API_Guid to IfcGloballyUniqueId string.
...
/** @brief Generates an IFC Difference based on the input parameters.
	@ingroup IFC
	@since Archicad 26
	@param viewGuid [in] Is a unique identifier of the View, which will be used for state generation.
	@param ifcTranslatorIdentifier [in] IFC Export Translator identifier.
	@param ifcDifferenceState [out] The resulting IFC Difference State.
	@return
		- NoError - The function has completed with success.
		- APIERR_BADPARS - Invalid view Guid or IFC Translator.
	@remarks It generates an IFC Difference State.
*/
...
/** @brief Generates an IFC Difference based on the input parameters.
	@ingroup IFC
	@since Archicad 26
	@param previousIFCDifferenceGeneratorState [in] Previous IFCDifference Generator state.
	@param currentIFCDifferenceGeneratorState [in] Current IFCDifference Generator state.
	@param ifcDifference [out] The resulting IFC Difference.
	@return
		- NoError - The function has completed with success.
		- APIERR_BADPARS - If any error occured during the conversion.
	@remarks It generates an IFC Difference based on the input parameters.
*/
...
/** @brief Augments the ifcDifference with previously deleted items and merges olderIfcRelationshipData with newerIfcRelationshipData.
	@ingroup IFC
	@since Archicad 26
	@param olderIfcRelationshipData [in] An olderly modified @ref API_IFCRelationshipData.
	@param newerIfcRelationshipData [in] A newerly modified @ref API_IFCRelationshipData.
	@param ifcDifference [in/out] The difference between the above two @ref API_IFCRelationshipData.
	@param mergedIfcRelationshipData [out] The merged result of the above two @ref API_IFCRelationshipData.
	@return
		- NoError - The function has completed with success.
		- APIERR_BADPARS - If any error occured executing the function.
	@remarks Merges olderIfcRelationshipData with newerIfcRelationshipData and complete ifcDifference with the deleted elements.
*/
...
*/
__APIEXPORT GSErrCode			__ACENV_CALL	ACAPI_IFC_InvokeIFCDifferenceExportSettingsDlg (API_Guid& viewGuid, API_IFCTranslatorIdentifier& ifcTranslatorIdentifier);
...
*/
__APIEXPORT UInt32			__ACENV_CALL	ACAPI_Licensing_GetProtectionMode ();
...
*/
__APIEXPORT UInt32  __ACENV_CALL	ACAPI_Licensing_GetSerialNumber ();
...
*/
__APIEXPORT UInt16  __ACENV_CALL	ACAPI_Licensing_GetBoxMask ();
...
*/
__APIEXPORT GS::UniString   __ACENV_CALL	ACAPI_Licensing_GetConfigurationNumber ();
...
*/
__APIEXPORT UInt32  __ACENV_CALL	ACAPI_Licensing_GetNumberOfLicenses ();
...
*/
__APIEXPORT GSTime  __ACENV_CALL	ACAPI_Licensing_GetExpirationTime ();
...
/** @brief When Archicad runs on an SSA license, this string contains the internal identifier of the reseller.
	...
	@return
*/
__APIEXPORT GS::UniString   __ACENV_CALL	ACAPI_Licensing_GetPartnerId ();
...
*/
__APIEXPORT bool    __ACENV_CALL	ACAPI_Licensing_IsSSALevelAtLeast (API_SSALevel requiredLevel);
...
/** @brief Search a dimension preference by name or index
	...
	@return
		...
		- APIERR_BADNAME
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_DimStand_Search (API_DimensionStandards_Head* dimStandHead);
...
/** @brief Get the number of dimension preferences
	...
	@return
		- NoError
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_DimStand_GetNum (UInt32& count);
...
/** @brief Get a dimension preference by index or name
	...
	@return
		...
		- APIERR_BADNAME
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_DimStand_Get (API_DimensionStandardsType&	dimStand);
...
/** @brief Search an API_ModelViewOptions_Head by name or index
	...
	@return
		...
		- APIERR_BADNAME
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ModelViewOptions_Search (API_ModelViewOptions_Head* mvoHead);
...
/** @brief Get the number of API_ModelViewOptions
	...
	@return
		- NoError
*/
__APIEXPORT void		__ACENV_CALL	ACAPI_Navigator_ModelViewOptions_GetNum (UInt32& count);
...
/** @brief Get an API_ModelViewOptionsType by index
	...
	@return
		...
		- APIERR_BADINDEX
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_ModelViewOptions_Get (API_ModelViewOptionsType* modelViewOpt);
