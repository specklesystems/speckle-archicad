...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_UnregisterTeamworkReserveInterface (const API_Guid& objectId,
																			 short			 dialogId = 0);
...
/** @brief Refreshes the registered teamwork interface.
	...
	@return
		- NoError - The function completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_RefreshTeamworkReserveInterface (const API_Guid&	objectId,
																			   short			dialogId,
...
/** @brief Sends the release comment mail.
	...
	@return
		- NoError - The function completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Teamwork_SendReleaseCommentMail (const API_Guid& objectId, short dialogId);
