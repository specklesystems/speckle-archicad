...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_UsableGDLString		(const char* str);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GeoLocation_CalcSunOnPlace		(API_PlaceInfo* placeInfo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_SearchElementByCoord		(const API_ElemSearchPars* elemSearchPars, API_Guid* foundElement);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Conversion_ConvertPicture		(API_PictureHandle* oldPict, API_PictureHandle* newPict);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Conversion_ConvertMimePicture		(API_MimePicture* mimePicture);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_OpenParameters		(API_ParamOwnerType* paramOwner);
...
/** @brief Returns the possible values defined for a Library Part parameter.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_LibraryPart_GetParamValues-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetParamValues		(API_GetParamValuesType* getValues);
...
/** @brief Changes a value in an opened Library Part parameter list.
	...
	@remarks This function is used to change a Library Part parameter. Refer to the @ref API_ChangeParamType structure to get details on the parametrization possibilities.
		...
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
	@par Example
		@snippet API_Examples.cpp ACAPI_LibraryPart_ChangeAParameter-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_ChangeAParameter		(API_ChangeParamType* changeParamType);
...
/** @brief Returns the actual (edited) values of a Library Part parameter list opened to edit.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_LibraryPart_GetActParameters-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetActParameters		(API_GetParamsType* theParams);
...
/** @brief Closes the Library Part parameter list opened for editing.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_LibraryPart_CloseParameters-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_CloseParameters		();
...
/** @brief Inserts a node into a polygon.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Polygon_InsertPolyNode-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_InsertPolyNode		(API_ElementMemo* elementMemo, Int32* nodeIndex, API_Coord* coord);
...
/** @brief Deletes a node from a polygon.
	...
	@remarks This function is used to delete a node from a polygon passed in an @ref API_ElementMemo structure.
		...
		Note that other memo handles are not touched. In the case the polygon belongs to a roof with side angles initialized, it must be aligned manually.
	@par Example
		@snippet API_Examples.cpp ACAPI_Polygon_DeletePolyNode-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_DeletePolyNode		(API_ElementMemo* memo, Int32* inIndex);
...
/** @brief Inserts a whole subpolygon (hole) into a polygon.
	...
	@remarks This function is used to insert a new subpolygon (hole) into a polygon passed in an @ref API_ElementMemo structure. The shape of the new hole should be passed in the insMemo parameter.
		...
		Note that other memo handles are not touched. In the case the polygon belongs to a roof with side angles initialized, it must be aligned manually.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_InsertSubPoly		(API_ElementMemo* memo, API_ElementMemo* insMemo);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_DeleteSubPoly		(API_ElementMemo* elementMemo, Int32* subPolyIndex);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_RegularizePolygon		(const API_RegularizedPoly* polygon, Int32* nResult, API_RegularizedPoly*** regularizedPolygons);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_RegularizePolyline		(const API_RegularizedPoly* polyline, API_RegularizedPoly* regularizedPolyline);
...
/** @brief Deallocates handles in an @ref API_RegularizedPoly struct.
	...
	@return
		...
		- APIERR_MEMFULL - low memory condition
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_DisposeRegularizedPoly		(API_RegularizedPoly* regularizedPoly);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_TriangulatePoly		(API_ElementMemo* memo, API_Coord *** coords);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_NeigToCoord		(API_Neig* neig, API_Coord3D* coord3D, API_Coord3D* coord3DDocument = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ProjectSetting_GetSplineMaxDist		(API_TestSplineFit* splinePars, double* distance);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Polygon_PolygonId2SurfaceType		(const API_Element* elem = nullptr, const Int32* polygonId = nullptr, API_SurfaceTypeID* surfaceType = nullptr);
...
/** @brief Initializes a parameter list to pass to an other add-on.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_AddOnAddOnCommunication_InitMDCLParameterList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_InitMDCLParameterList		(GSHandle* params);
...
/** @brief Retrieves the number of the parameters on the parameter list.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_AddOnAddOnCommunication_GetMDCLParameterNum-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_GetMDCLParameterNum		(GSHandle params, Int32* nPars);
...
/** @brief Appends a parameter to the parameter list.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_AddOnAddOnCommunication_AddMDCLParameter-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_AddMDCLParameter		(GSHandle params, API_MDCLParameter* mDCLParameter);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_GetMDCLParameter		(GSHandle params, API_MDCLParameter* mDCLParameter);
...
/** @brief Modifies a parameter on the parameter list.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_AddOnAddOnCommunication_ChangeMDCLParameter-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_ChangeMDCLParameter		(GSHandle params, API_MDCLParameter* mDCLParameter);
...
/** @brief Frees the parameter list handle.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_AddOnAddOnCommunication_FreeMDCLParameterList-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AddOnAddOnCommunication_FreeMDCLParameterList		(GSHandle* params);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetTextLineLength		(API_TextLinePars* textLinePars, double* length);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetTextSizeFactor		(short* api_fontID, double* textSizeFactor);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_ModelAccess_GetTextureCoord		(API_TexCoordPars* texCoordPars, API_UVCoord* uvCoord);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetBuiltInLibpartUnId		(short templateFileResID, char* lpfUnId);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetUnloadedLibpartName		(const API_Guid* guid, GS::UniString* name);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_CheckLibPartSubtypeOf		(const char* successorUnIDStr, const char* predecessorUnIDStr);
...
/** @brief Checks whether a library part unique ID refers to a subtype of another.
	...
	@remarks This function is used to verify that a library part identified by its unique ID is a subtype of the other one identified only by the main part of its unique ID.
		...
		It checks for real ancestry so returns APIERR_NOTSUBTYPEOF for equal unique IDs as well.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_CheckLibPartSubtypeOfbyMain		(const char* successorUnIDStr, const char* predecessorUnIDStr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_CompareLibPartUnIds		(const char* unIDStr1, const char* unIDStr2);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetElemCreatorToolUnId		(API_Elem_Head* elemHead, char* unIDStr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetElemLibPartUnId		(API_Elem_Head* elemHead, char* lpfUnId);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryPart_GetLibPartToolVariation		(API_LibPart* libPart, API_ToolBoxItem* toolboxItem);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_SetEmptyHoleUnId		(GSType* signature, const char* emptyHoleUnIdStr, const char* emptyOpeningSubtypeUnIDStr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_ChangeContent		(API_ContentPars* contentPars);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_GetAutoTextFlag		(bool* showAutoText);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_ChangeAutoTextFlag		(bool* showAutoText);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_GetAutoTextKeys		(char*** keys, char*** values);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_GetPropertyAutoTextKeyTable		(API_Guid* guid, GS::HashTable<GS::UniString, GS::UniString>* keyGuidTable);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_InterpretAutoText		(const GS::UniString* autotext, const API_Guid* guid, GS::UniString* value);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_GetAutoTexts		(GS::Array<GS::ArrayFB<GS::UniString, 3>>* autotexts, API_AutotextType autotextType);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_SetAnAutoText		(const GS::UniString* autotextDbKey = nullptr, const GS::UniString* autotextValue = nullptr);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Grouping_GetMainGroupGuid		(const API_Guid* groupGuid, API_Guid* mainGroupGuid);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Hotlink_GetContainingHotlinkGuid		(const API_Guid* elemGuid, API_Guid* hotlinkElemGuid);
...
/** @brief Run GDL parameter script.
	...
	@remarks You are eble to run the GDL parameter script of an object, lamp, window or door element via this function.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_RunGDLParScript		(const API_Elem_Head* elemHead, UInt32 mask = 0);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_CreateAnAutoText		(const API_Guid* guid, const char* uiKey);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_AutoText_DeleteAnAutoText		(const char* dbKey);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CurtainWall_GetCWAbsoluteBottom		(const API_Guid* guid, double* bottom);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CurtainWall_GetCWHeight		(const API_Guid* guid, double* height);
...
/** @brief Returns the calculated additional parameters of a curtain wall subelem.
	...
	@remarks This function is used to obtain the additional parameters of a library part-based curtain wall subelem (panel, frame, junction, accessory). Don't forget to call @ref ACAPI_DisposeElemMemoHdls to dispose the params handle when you're done.
		This function is a non-undoable data structure modifier function. See more details on this topic at Command Overview.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_CurtainWall_GetCWSubElemParams		(const API_Guid* guid, API_AddParType*** params);
...
/** @brief Returns the polygon data of a Skylight hole contour.
	...
	@par Example
		@snippet API_Examples.cpp ACAPI_Element_GetSkylightHolePolygon-Example-Snippet
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetSkylightHolePolygon		(const API_Guid* skylightGuid, Geometry::Polygon2D* holePoly);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_EnableRenovationOverride		(bool* oldOverrideVal, const bool* newOverrideVal);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_GraphicalOverride_EnableVisualOverride		(bool* oldOverrideVal, const bool* newOverrideVal);
...
/** @brief Returns the name of the renovation status.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Renovation_GetRenovationStatusName		(API_RenovationStatusType renovationStatusType, GS::UniString* statusName);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Renovation_GetRenovationFilterName		(const API_Guid* renovationFilterGuid, GS::UniString* renovationFilterName);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Navigator_SetMasterLayoutOnLayout		(const API_DatabaseUnId* databaseUnId = nullptr);
...
/** @brief Returns user building material connection priority for a interface priority.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_UI2ElemPriority		(GS::Int32* uiPriority, GS::Int32* elemPriority);
...
/** @brief Returns user interface priority for a building material connection priority.
	...
	@return
		- NoError - The function has completed with success.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_Elem2UIPriority		(GS::Int32* elemPriority, GS::Int32* uiPriority);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_CalcSideOffsetToCoreOffset		(const API_Guid* wallOpeningGuid, const double* sideOffset, double* coreOffset);
...
/** @brief Converts the reveal depth offset from core skin to wall side for wall openings.
	...
	@remarks This function can be used for wall openings in composite walls (side offset and core offset is equal in walls with basic structure).
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_CalcCoreOffsetToSideOffset		(const API_Guid* wallOpeningGuid, const double* coreOffset, double* sideOffset);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_ElemHasVisibleSkin		(const API_Guid* elemGuid, const API_StructureDisplay* structure, bool* result);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetOpeningTransformation		(const API_Guid* elemGuid, API_Tranmat* openingTranMat);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Selection_GetSelectedElement		(const API_Neig* apiNeig, API_Guid* apiGuid);
...
/** @brief Converts an @ref API_Guid structure to an @ref API_Neig.
	...
	@return
		...
		- APIERR_BADPARS - apiGuid or apiNeig is nullptr.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Selection_SetSelectedElementNeig		(const API_Guid* apiGuid, API_Neig* apiNeig);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_SolveStair		(API_StairType* apiStair, API_ElementMemo* apiMemo, API_StairSolutionID* solution);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_CheckPropertyExpressionString		(GS::UniString* expressionString);
...
/** @brief Returns the string that can be used in expressions to refer to a specific property.
	...
	@return
		...
		- APIERR_BADPARS - Some of the parameters are nullptr.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Property_GetPropertyExprReferenceString		(API_PropertyDefinition* propertyDefinition, GS::UniString* propertyReferenceString);
...
/** @brief Returns the owner of the child elem in hierarchical elem.
	...
	@return
		...
		- APIERR_BADPARS - Some of the parameters are nullptr.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_HierarchicalEditing_GetHierarchicalElementOwner		(const API_Guid* elemApiGuid, const API_HierarchicalOwnerType* hierarchicalOwnerType, API_HierarchicalElemType* hierarchicalElemType, API_Guid* ownerElemApiGuid);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Element_GetRoomImage		(API_RoomImage* roomImage);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_LibraryManagement_InterpretGDLScript3D		(const GS::UniString* script, API_AddParType** addPars, void* modelerAPIModel = nullptr, void* modelerModel = nullptr);
...
/** @brief Returns the HTTP port number, on which Archicad is expecting requests.
	...
	@remarks This function is used to get the HTTP port on which the Add-On commands, registered via @c ACAPI_AddOnAddOnCommunication_InstallAddOnCommandHandler, can be accessed.
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Command_GetHttpConnectionPort		(UShort* portNumber);
...
*/
__APIEXPORT GSErrCode	__ACENV_CALL	ACAPI_Dialog_ActivateSessionReport		();
...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_LibraryPart_GetMarkerParent (const API_ElemType &elemType,
																  API_LibPart		 &libPart);
...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_Element_GetElemTypeName (const API_ElemType &elemType,
...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_Element_NeigIDToElemType (API_NeigID neigID, API_ElemType &elemType);
...
*/
__APIEXPORT GSErrCode __ACENV_CALL ACAPI_Element_ElemTypeToNeigID (const API_ElemType &elemType,
																   API_NeigID		  &neigID);
