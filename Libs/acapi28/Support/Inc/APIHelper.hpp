...
extern "C" {
#endif
	__APIEXPORT GSErrCode			ACAPI_Internal (API_InternalID code, void *par1 = nullptr, void *par2 = nullptr, void *par3 = nullptr);
...
typedef GSErrCode		APICommandFunctionProc (void*);
...
__APIEXPORT GSErrCode		ACAPI_Link_CreateHotlinkSourceProject	(const API_AddOnFileOpenParameters&								addOnFileOpenParameters,
...
extern "C" {
#endif
	__APIEXPORT GSErrCode		ACAPI_Install_SubtypeHandlers (
												GSType					signature,
												CBMakeNewElemProc		makeNewElemCBProc,
												CBDrawSProc				nullLevelCBDrawProc);
#ifdef __cplusplus
...
extern "C" {
#endif
	__APIEXPORT GSErrCode		ACAPI_Register_SubtypeX	(GSType				signature,
	...
	__APIEXPORT GSErrCode		ACAPI_Register_BuiltInSubtype	(GSType				signature,
...
extern "C" {
#endif
	__APIEXPORT GSErrCode		ACAPI_Register_Tool (GSType signature);		// interface description

	__APIEXPORT GSErrCode		ACAPI_Install_ToolHandler (GSType						signature,
...
extern "C" {
#endif
	__APIEXPORT EDB::IElemRegistry*		ACAPI_EDB_GetElemRegistry (void);
	__APIEXPORT EDB::IElemDefaults*		ACAPI_EDB_GetElemDefaults (void);
	__APIEXPORT EDB::IElemDatabase*		ACAPI_EDB_GetElemDatabase (API_ElemDatabaseID type, Int32 id);
	__APIEXPORT short					ACAPI_PStatus  (Geometry::Coord*	cc,				//PT
...
extern "C" {
#endif
	__APIEXPORT ILMInterface*			ACAPI_InputInterface_GetInputLevelManager (void);
	__APIEXPORT IFeedBack*				ACAPI_InputInterface_GetFeedBack (void);
#ifdef __cplusplus
}
#endif
#endif
...
typedef GSErrCode		APIConvertGroupMemoToHotlinkNodeProc (GSType ownerId, const API_GroupHead** groupData, API_HotlinkNode* hotlinkNode, double& drawingUnit);
typedef GSErrCode		APIConvertHotlinkNodeToGroupMemoProc (GSType ownerId, const API_HotlinkNode* hotlinkNode, API_GroupHead*** groupData);
typedef GSErrCode		APIConvertHotlinkNodeProc (GSType ownerId, API_HotlinkNode* newhotlinkNode, const API_HotlinkNode* oldhotlinkNode);	// hotlinkNode is In/Out parameter!!!
typedef GSErrCode		APIGetOldVersionCompatibleUserDataProc (GSType ownerId, GSPtr* userData, const API_HotlinkNode* hotlinkNode);	// the addon allocates 'userData'...
...
typedef GSErrCode		APIConvertTranslatorToOldVersionProc (GSType ownerId, const GSPtr actver_content, GSPtr* oldver_content);

typedef struct {
		APIConvertTranslatorToOldVersionProc*	convertTranslatorToOldVersion;
} API_TranslatorConverterProcs;

typedef GSErrCode		APITranslatorProc (Localization::PoDictionary& dictionary);
...
extern "C" {
#endif
	__APIEXPORT GSErrCode						ACAPI_Register_IESUtil (IES::IIESUtil* iesutil);
	__APIEXPORT IES::ACUtil*					ACAPI_GetACUtil (void);
	__APIEXPORT IES::IESCommonDBManager*		ACAPI_GetIESDBManager (void);
	__APIEXPORT IES::IESLinkManager*			ACAPI_GetIESLinkManager (void);
#ifdef __cplusplus
}
#endif
...
extern "C" {
#endif
	__APIEXPORT GSErrCode				ACAPI_SetUnloadable (bool unloadable);
	__APIEXPORT UtilityFunctionSet*		ACAPI_GetUtilityFunctionSet (void);
	__APIEXPORT IProductRegistry*		ACAPI_GetProductRegistry (void);
#ifdef __cplusplus
}
#endif
