...
virtual GS::OChannel& GetOChannel (const type& forType, const API_ElemType& elemType,									\
...
public:
	...
	APIOUTPUT (API_ElemType)
	APIOUTPUT (API_BeamSegmentType)
	APIOUTPUT (API_BeamShapeTypeID)
	APIOUTPUT (API_ColumnSegmentType)
	...
	APIOUTPUT (API_BeamVisibleLinesID)
	...
	APIOUTPUT (API_CoverFillTransformation)
	APIOUTPUT (API_CoverFillTransformationTypeID)
	...
	APIOUTPUT (API_DimTextFillOrderID)
	...
	APIOUTPUT (API_Niche)
	APIOUTPUT (API_Obsolete_ComponentRefType)
	...
	APIOUTPUT (API_TextFrameType)
	APIOUTPUT (API_TextFrameShapeTypeID)

	// API Element Memo Types
	APIOUTPUT (API_ElementMemo)
	APIOUTPUT (API_AssemblySegmentCutTypeID)
	APIOUTPUT (API_AssemblySegmentData)
	APIOUTPUT (API_AssemblySegmentLengthTypeID)
	APIOUTPUT (API_AssemblySegmentCutData)
	APIOUTPUT (API_AssemblySegmentSchemeData)
	...
	APIOUTPUTOTYPE (API_DimensionStandards_Head)
	APIOUTPUTOTYPE (API_DimensionStandardsType)
	...
	APIOUTPUTOTYPE (API_ModelViewOptions_Head)
	...
	APIOUTPUT (API_PropertyValueStatus)
	...
	APIOUTPUT (API_OverrideRuleGroup)
};
