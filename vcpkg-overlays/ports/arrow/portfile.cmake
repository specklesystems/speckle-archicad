...
# ── speckle-archicad overlay patch (v142 compat) ──
# MSVC 14.29 (v142, AC27/28) loses sight of a constexpr local referenced inside nested
# generic lambdas in parquet/decoder.cc ('kBufferSize': undeclared identifier). 'static
# constexpr' is semantically identical and compiles on every toolset (incl. v143). Done as
# a vcpkg_replace_string rather than a .patch so it is robust to upstream line drift. The
# three declarations (two = 1024, one = 2048) are all promoted.
vcpkg_replace_string("${SOURCE_PATH}/cpp/src/parquet/decoder.cc"
    "constexpr int32_t kBufferSize = 1024;" "static constexpr int32_t kBufferSize = 1024;")
vcpkg_replace_string("${SOURCE_PATH}/cpp/src/parquet/decoder.cc"
    "constexpr int32_t kBufferSize = 2048;" "static constexpr int32_t kBufferSize = 2048;")
...
# speckle-archicad overlay: force SIMD off on x64 too (upstream only does this for arm64).
# v142 (MSVC 14.29) cannot compile Arrow 24's constexpr-heavy SIMD bit-packing kernels
# (bpacking_simd_kernel_internal.h); keeping v143 scalar as well gives AC 27/28/29 identical
# Parquet decode behavior. Scalar unpacking is an accepted perf trade for the add-on.
if(VCPKG_TARGET_IS_WINDOWS)
    list(APPEND FEATURE_OPTIONS "-DARROW_SIMD_LEVEL=NONE")
    list(APPEND FEATURE_OPTIONS "-DARROW_RUNTIME_SIMD_LEVEL=NONE")
endif()
